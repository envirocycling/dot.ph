...
//            }
            ...
            foreach ($array_of_dates as $date) {
                ...
                $total_amount = 0;
                if ($group == 'MW') {
                    $sql_amount = mysql_query("Select * from paper_buying WHERE dr_number!='' and (wp_grade like '%CORETUBE%' or wp_grade like '%CT%' or wp_grade like '%LCAP_K%' or wp_grade like '%MW%') and date_received='$date' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'");
                } else if ($group == 'ONP') {
                    $sql_amount = mysql_query("Select * from paper_buying WHERE dr_number!='' and (wp_grade like '%ONP%' or wp_grade like '%OPD%' or wp_grade like '%NPB%' or wp_grade like '%OIN%') and date_received='$date' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'");
                } else if ($group == 'OCC') {
                    $sql_amount = mysql_query("Select * from paper_buying WHERE dr_number!='' and (wp_grade like '%HM.OCC%' or wp_grade like '%LCOCC%' or wp_grade like '%WT.OCC%' or wp_grade like '%OCC%' or wp_grade like '%OLD.CC%') and date_received='$date' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'");
                } else if ($group == 'LCWL') {
                    $sql_amount = mysql_query("Select * from paper_buying WHERE dr_number!='' and (wp_grade like '%BOOK.LCWL%' or wp_grade like '%GUMS.LCWL%' or wp_grade like '%LCWL STICKIES%' or wp_grade like '%WL%' or wp_grade like '%LCWL%') and date_received='$date' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'");
                } else if ($group == 'CHIPBOARD') {
                    $sql_amount = mysql_query("Select * from paper_buying WHERE dr_number!='' and wp_grade like '%CHIPBOARD%' and date_received='$date' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'");
                } else if ($group == 'CBS') {
                    $sql_amount = mysql_query("Select * from paper_buying WHERE dr_number!='' and wp_grade like '%CBS%' and date_received='$date' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'");
                } else {
                    $sql_amount = mysql_query("Select * from paper_buying WHERE dr_number!='' and (wp_grade like '%ONP%' or wp_grade like '%OPD%' or wp_grade like '%NPB%' or wp_grade like '%OIN%' OR wp_grade like '%CBS%' or wp_grade like '%CHIPBOARD%' or wp_grade like '%BOOK.LCWL%' or wp_grade like '%GUMS.LCWL%' or wp_grade like '%LCWL STICKIES%' or wp_grade like '%WL%' or wp_grade like '%LCWL%' or wp_grade like '%HM.OCC%' or wp_grade like '%LCOCC%' or wp_grade like '%WT.OCC%' or wp_grade like '%OCC%' or wp_grade like '%OLD.CC%'  or wp_grade like '%CORETUBE%' or wp_grade like '%CT%' or wp_grade like '%LCAP_K%' or wp_grade like '%MW%' or wp_grade like '%BOOK.LCWL%' or wp_grade like '%GUMS.LCWL%' or wp_grade like '%LCWL STICKIES%' or wp_grade like '%WL%') and date_received='$date' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'");
                }
    ...
    <div class="grid_10">
        ...
        <div class="box round first grid">
            ...
            <table class="data display datatable" id="example">
                ...
                if ($group == 'MW') {
                    $query = "Select * from paper_buying WHERE dr_number!='' and (wp_grade like '%CORETUBE%' or wp_grade like '%CT%' or wp_grade like '%LCAP_K%' or wp_grade like '%MW%') and date_received>='$from' and date_received<='$to' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'";
                } else if ($group == 'ONP') {
                    $query = "Select * from paper_buying WHERE dr_number!='' and (wp_grade like '%ONP%' or wp_grade like '%OPD%' or wp_grade like '%NPB%' or wp_grade like '%OIN%') and date_received>='$from' and date_received<='$to' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'";
                } else if ($group == 'OCC') {
                    $query = "Select * from paper_buying WHERE dr_number!='' and (wp_grade like '%HM.OCC%' or wp_grade like '%LCOCC%' or wp_grade like '%WT.OCC%' or wp_grade like '%OCC%' or wp_grade like '%OLD.CC%') and date_received>='$from' and date_received<='$to' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'";
                } else if ($group == 'LCWL') {
                    $query = "Select * from paper_buying WHERE dr_number!='' and (wp_grade like '%BOOK.LCWL%' or wp_grade like '%GUMS.LCWL%' or wp_grade like '%LCWL STICKIES%' or wp_grade like '%WL%' or wp_grade like '%LCWL%') and date_received>='$from' and date_received<='$to' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'";
                } else if ($group == 'CHIPBOARD') {
                    $query = "Select * from paper_buying WHERE dr_number!='' and wp_grade like '%CHIPBOARD%' and date_received>='$from' and date_received<='$to' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'";
                } else if ($group == 'CBS') {
                    $query = "Select * from paper_buying WHERE dr_number!='' and wp_grade like '%CBS%' and date_received>='$from' and date_received<='$to' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'";
                } else {
                    $query = "Select * from paper_buying WHERE dr_number!='' and (wp_grade like '%CBS%' or wp_grade like '%CHIPBOARD%' or wp_grade like '%BOOK.LCWL%' or wp_grade like '%GUMS.LCWL%' or wp_grade like '%LCWL STICKIES%' or wp_grade like '%WL%' or wp_grade like '%LCWL%' or wp_grade like '%HM.OCC%' or wp_grade like '%LCOCC%' or wp_grade like '%WT.OCC%' or wp_grade like '%OCC%' or wp_grade like '%OLD.CC%'  or wp_grade like '%CORETUBE%' or wp_grade like '%CT%' or wp_grade like '%LCAP_K%' or wp_grade like '%MW%' or wp_grade like '%BOOK.LCWL%' or wp_grade like '%GUMS.LCWL%' or wp_grade like '%LCWL STICKIES%' or wp_grade like '%WL%') and date_received>='$from' and date_received<='$to' and branch like '%$branch%' and dr_number NOT LIKE '%export%' and dr_number NOT LIKE '%others%'";
                }
        ...
        <div class="box round first grid">
            ...
            <form method='POST' action='paper_buying_dr_exec.php'>
                ...
                <table class="data display datatable" id="example">
                    ...
                    if ($group == 'MW') {
                        $query = "Select * from paper_buying WHERE (wp_grade like '%CORETUBE%' or wp_grade like '%CT%' or wp_grade like '%LCAP_K%' or wp_grade like '%MW%') and date_received>='$from' and date_received<='$to' and dr_number='' and branch like '%$branch%'";
                    } else if ($group == 'ONP') {
                        $query = "Select * from paper_buying WHERE (wp_grade like '%ONP%' or wp_grade like '%OPD%' or wp_grade like '%NPB%' or wp_grade like '%OIN%') and date_received>='$from' and date_received<='$to' and branch like '%$branch%'";
                    } else if ($group == 'OCC') {
                        $query = "Select * from paper_buying WHERE (wp_grade like '%HM.OCC%' or wp_grade like '%LCOCC%' or wp_grade like '%WT.OCC%' or wp_grade like '%OCC%' or wp_grade like '%OLD.CC%') and date_received>='$from' and date_received<='$to' and dr_number='' and  branch like '%$branch%'";
                    } else if ($group == 'LCWL') {
                        $query = "Select * from paper_buying WHERE (wp_grade like '%BOOK.LCWL%' or wp_grade like '%GUMS.LCWL%' or wp_grade like '%LCWL STICKIES%' or wp_grade like '%WL%' or wp_grade like '%LCWL%') and date_received>='$from' and date_received<='$to' and dr_number='' and branch like '%$branch%'";
                    } else if ($group == 'CHIPBOARD') {
                        $query = "Select * from paper_buying WHERE wp_grade like '%CHIPBOARD%' and date_received>='$from' and date_received<='$to' and dr_number='' and branch like '%$branch%'";
                    } else if ($group == 'CBS') {
                        $query = "Select * from paper_buying WHERE wp_grade like '%CBS%' and date_received>='$from' and date_received<='$to' and dr_number='' and branch like '%$branch%'";
                    } else {
                        $query = "Select * from paper_buying WHERE (wp_grade like '%CBS%' or wp_grade like '%BOOK.LCWL%' or wp_grade like '%GUMS.LCWL%' or wp_grade like '%LCWL STICKIES%' or wp_grade like '%WL%' or wp_grade like '%LCWL%' or wp_grade like '%HM.OCC%' or wp_grade like '%LCOCC%' or wp_grade like '%WT.OCC%' or wp_grade like '%OCC%' or wp_grade like '%OLD.CC%'  or wp_grade like '%CORETUBE%' or wp_grade like '%CT%' or wp_grade like '%LCAP_K%' or wp_grade like '%MW%' or wp_grade like '%BOOK.LCWL%' or wp_grade like '%GUMS.LCWL%' or wp_grade like '%LCWL STICKIES%' or wp_grade like '%WL%') and date_received>='$from' and date_received<='$to' and dr_number='' and branch like '%$branch%'";
                    }
