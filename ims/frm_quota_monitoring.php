...
<div class="grid_5">
    <div class="box round first grid">
        <h2>Quota Monitoring Reports</h2>
        <form action="quota_monitoring.php" method="POST">
            <br>
            ...
            while($row = mysql_fetch_array($result)) {
                if ($row['wp_grade']!='lcwl' && $row['wp_grade']!='chipboard' ) {
                    $dropdown .= "\r\n<option value='lc".$row['wp_grade']."'>{$row['wp_grade']}</option>";
                }else {
