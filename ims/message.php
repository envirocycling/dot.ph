        ...
        <div class="holder">
            ...
            <div class="style">
                <div class="alpha">
                    ...
                    <br/>
                    <form method="POST" name="newMessage" class="newMessage" action="message.php">
                        <input name="from_id" type="hidden" id="texta" value="<?php echo $_SESSION['username']; ?>"/>
                        <input name="to_id" type="hidden" id="recipient" value="lonlon"/>
