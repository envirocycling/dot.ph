...
<div class="grid_10"> 
    <div class="box round first grid">
        <h2><?php $ngayon=date('F d, Y');
            echo "<h2> Daily Receiving for ".date('F')." as of : <u><b><i>".$ngayon."</i></b></u></h2>"; ?></h2>
        <div class="block">
            <?php
            ...
            Month: <select name="weekly_month"><option value="<?php echo $_SESSION['weekly_month'];?>"><?php echo $_SESSION['weekly_month'];?></option>                <option value="January">January</option>                <option value="February">February</option>                <option value="March">March</option>                <option value="April">April</option>                <option value="May">May</option> <option value="June">June</option><option value="July">July</option>                <option value="August">August</option>                <option value="September">September</option>                <option value="October">October</option>                <option value="November">November</option>                <option value="December">December</option>            </select>            Year: <select name="weekly_year">                <option value="<?php echo $_SESSION['weekly_year'];?>"><?php echo $_SESSION['weekly_year'];?></option>                <option value="2011">2011</option>                <option value="2012">2012</option>                <option value="2013">2013</option>                <option value="2014">2014</option>                <option value="2015">2015</option>                <option value="2016">2016</option>                <option value="2017">2017</option>                <option value="2018">2018</option>                <option value="2019">2019</option>                <option value="2020">2020</option>            </select>            
            <?php
            echo '<input type="submit" name="submit" value="Submit">';
            echo "</form><br>";            ?>            <div class="block">
                
                <table class="data display datatable" id="example">                    <?php                    echo "<thead>";
                    ...
                    echo "</thead>";
                    $query="SELECT * FROM sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status !='inactive' and month_delivered='".$_SESSION['weekly_month']."' and year_delivered='".$_SESSION['weekly_year']."' and branch_delivered like '%".$_SESSION['weekly_branch']."%' group by sup_deliveries.supplier_name";
                    $result=mysql_query($query);                    while($row = mysql_fetch_array($result)) {
                        array_push($branch_array,$row['supplier_name']);
                            ...
                            =array();
                    if($_SESSION['usertype']=='Super User') {
                        $query3="SELECT supplier_details.supplier_name as supplier_name,sum(weight),date_delivered FROM sup_deliveries  join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status !='inactive' and  month_delivered='".$_SESSION['weekly_month']."' and year_delivered='".$_SESSION['weekly_year']."' and wp_grade like '%".$_SESSION['weekly_wp_grade']."%' and branch_delivered like '%".$_SESSION['weekly_branch']."%' group by supplier_name,date_delivered";
                    }else {
                        $query3="SELECT supplier_details.supplier_name as supplier_name,sum(weight),date_delivered FROM sup_deliveries  join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status !='inactive' and  month_delivered='".$_SESSION['weekly_month']."' and year_delivered='".$_SESSION['weekly_year']."' and wp_grade like '%".$_SESSION['weekly_wp_grade']."%' and branch_delivered = '".$_SESSION['user_branch']."' group by supplier_name,date_delivered";
                    }                    $result3
