...
<div class="grid_10">
    <div class="box round first grid">
        <h2>Uploading of Receiving Template</h2>
        <h3><i>Kindly upload XML files only <i></h3><br>
                    <?php if ($branch == 'Sauyo') {?>
                        <form action="importspecial.php" method="post"
                          enctype="multipart/form-data">
                    <?php } else if ($branch == 'Pampanga') {?>
                        <form action="importspecialpamp.php" method="post"
                          enctype="multipart/form-data">
                    <?php } else {?>
