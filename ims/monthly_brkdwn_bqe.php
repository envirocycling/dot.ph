...
<h2><?php $ngayon=date('F d, Y');
    ...
    <table class="data display datatable" id="example">
        ...
        echo "<th>ID</th>";
        echo "<th>________Supplier Name_______</th>";
        ...
        echo "</thead>";
        if($_SESSION['weekly_branch']=='Sauyo/Kaybiga') {
            $query="SELECT supplier_id FROM sup_deliveries group by supplier_id";
        }else {
            $query="SELECT supplier_id FROM sup_deliveries group by supplier_id";
        ...
        foreach ($supplier_array as $value2) {
            ...
            if(!empty($supplier_details_array[$value2])) {
                ...
                echo "<td id='left_header' >".$supplier_details[0]."</td>";
                ...
                echo "<td id='left_header' >UNKNOWN</a></td>";
