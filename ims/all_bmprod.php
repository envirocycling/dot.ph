...
<div class="grid_10">
    <div class="box round first grid">
        ...
        if($from=='') {
            echo "<h2> "."CONSOLIDATED"." BM PRODUCTION as of: <u><b><i>".$ngayon."</i></b></u></h2>";
        }else {
            echo "<h2> "."CONSOLIDATED"." BM PRODUCTION for the period:<u><b><i>".$from." to ".$to."</i></b></u></h2>";
        ...
        <table class="data display datatable" id="example">
            ...
            include("config.php");
            if($from=='') {
                $query="SELECT * FROM bm_prod where date like '%$month%' ";
            }else {
                $query="SELECT * FROM bm_prod where  date between '$from' and '$to'";
...
<div class="grid_3">
    <div class="box round first grid">
        ...
        if($from=='') {
            echo "<h2> "."CONSOLIDATED"." MINUTES/GRADE as of: <u><b><i>".$ngayon."</i></b></u></h2>";
        }else {
            echo "<h2> "."CONSOLIDATED"." MINUTES/GRADE for the period: <u><b><i>".$from." to ".$to."</i></b></u></h2>";
        ...
        <table class="data display datatable" id="example">
            ...
            foreach($_SESSION['wp_grades'] as $wp_grade) {
                ...
                if($from=='') {
                    $query="SELECT minutes FROM bm_prod where wp_grade='$wp_grade' and date like '%$month%'";
                }else {
                    $query="SELECT minutes FROM bm_prod  where   wp_grade='$wp_grade' and date between '$from' and '$to' ";
...
<div class="grid_3">
    <div class="box round first grid">
        ...
        if($from=='') {
            echo "<h2> "."CONSOLIDATED"." SUM OF BALES as of: <u><b><i>".$ngayon."</i></b></u></h2>";
        }else {
            echo "<h2> "."CONSOLIDATED"." SUM OF BALES for the period: <u><b><i>".$from." to ".$to."</i></b></u></h2>";
        ...
        <table class="data display datatable" id="example">
            ...
            $total_time='';
            if($from=='') {
                $query="SELECT wp_grade,sum(no_of_bales) FROM bm_prod where   date like '%$month%' group by wp_grade ";
            }else {
                $query="SELECT wp_grade,sum(no_of_bales) FROM bm_prod where  date between '$from' and '$to' group by wp_grade ";
...
<div class="grid_3">
    <div class="box round first grid">
        ...
        if($from=='') {
            echo "<h2> "."CONSOLIDATED"." SUM OF BALE Wt. as of: <u><b><i>".$ngayon."</i></b></u></h2>";
        }else {
            echo "<h2> "."CONSOLIDATED"." SUM OF BALE Wt. for the period: <u><b><i>".$from." to ".$to."</i></b></u></h2>";
        ...
        <table class="data display datatable" id="example">
            ...
            $total_time='';
            if($from=='') {
                $query="SELECT wp_grade,sum(bale_weight) FROM bales where  date like '%$month%' group by wp_grade ";
            }else {
                $query="SELECT wp_grade,sum(bale_weight) FROM bales where  date between '$from' and '$to' group by wp_grade ";
...
<div class="grid_10">
    <div class="box round first grid">
        ...
        if($from=='') {
            echo "<h2> "."CONSOLIDATED"." Actual Bales. as of: <u><b><i>".$ngayon."</i></b></u></h2>";
        }else {
            echo "<h2> "."CONSOLIDATED"." Actual Bales. for the period  : <u><b><i>".$from." to ".$to."</i></b></u></h2>";
        ...
        <table class="data display datatable" id="example">
            ...
            include("config.php");
            if($from=='') {
                $query="SELECT  * FROM bales where str_no=0 and date like '%$month%'";
            }else {
                $query="SELECT  * FROM bales where str_no=0  and date between '$from' and '$to'";
            ...
            while($row = mysql_fetch_array($result)) {
                ...
                echo "<td class='data'><a rel='facebox' href='editBale.php?bale_id=".$row['log_id']."'><button>Edit</button></a><a rel='facebox' href='deleteBaleVerification.php?bale_id=".$row['log_id']."'><button>Delete</button></a></td>";
                echo "</tr>";
...
<div class="grid_10">
    <div class="box round first grid">
        ...
        if($from=='') {
            echo "<h2> "."CONSOLIDATED"." BM PERFORMANCE SUMMARY as of: <u><b><i>".$ngayon."</i></b></u></h2>";
        }else {
            echo "<h2> "."CONSOLIDATED"." BM PERFORMANCE SUMMARY for the period: <u><b><i>".$from." to ".$to."</i></b></u></h2>";
        ...
        <table class="data display datatable" id="example">
            ...
            if($from =='') {
                ...
                $query="SELECT bm_prod.wp_grade as bm_grade,sum(bm_prod.no_of_bales) as bm_count, sum(bales.bale_weight) as weight,sum(bm_prod.minutes) as minutes FROM bm_prod join bales on bales.wp_grade=bm_prod.wp_grade where  bm_prod.date like '%$month%' group by bales.wp_grade; ";

            }else {
                $query="SELECT bm_prod.wp_grade as bm_grade,sum(bm_prod.no_of_bales) as bm_count, sum(bales.bale_weight) as weight,sum(bm_prod.minutes) as minutes FROM bm_prod join bales on bales.wp_grade=bm_prod.wp_grade where  bm_prod.date between '$from' and '$to' group by bales.wp_grade; ";
            ...
            while($row = mysql_fetch_array($result)) {
                if($from =='') {
                    ...
                    $query2="SELECT minutes,no_of_bales FROM bm_prod where  wp_grade='".$row['bm_grade']."' and date like '%$month%' ";
                }else {
                    $query2="SELECT minutes,no_of_bales FROM bm_prod where  and wp_grade='".$row['bm_grade']."' and date between '$from' and '$to'";
                ...
                echo "<tr>";
                if($from=='') {
                    $query5="SELECT sum(bale_weight) from bales where wp_grade='".$row['bm_grade']."' and date like '%$month%' group by wp_grade";

                }else {
                    $query5="SELECT sum(bale_weight) from bales where wp_grade='".$row['bm_grade']."'  and date between '$from' and '$to' group by wp_grade";
