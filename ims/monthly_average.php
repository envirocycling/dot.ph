    ...
    <div class="box round first grid">
        <h2><?php
            ...
            <table class="data display datatable" id="example">
                ...
                echo "<th>Current Week vs Prev Month AVG.</th>";
                ...
                if(trim($filtering_grade)!='') {
                    ...
                    if($filtering_branch=='Sauyo/Kaybiga') {
                        $query3="SELECT sup_deliveries.supplier_id as supplier_id,sum(weight),date_delivered,month_delivered FROM sup_deliveries  join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status!='inactive' and month_delivered='$weekly_month' and year_delivered='$weekly_year'  and   (branch_delivered ='Kaybiga' or branch_delivered ='Sauyo') group by supplier_details.supplier_id,date_delivered";
                    }else {
                        $query3="SELECT sup_deliveries.supplier_id as supplier_id,sum(weight),date_delivered,month_delivered FROM sup_deliveries  join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status!='inactive' and month_delivered='$weekly_month' and year_delivered='$weekly_year'  and branch_delivered like '%".$filtering_branch."%' group by supplier_details.supplier_id,date_delivered";
                    }
                }
...
////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    foreach($months_array as $months) {
                        ...
                        if(!empty($deliveries_per_month[$key_finder2])) {
                            ...
                            $total_deliveries_per_supplier+=($deliveries_per_month[$key_finder2]/$divider);
                            $total_deliveries_all_supplier+=($deliveries_per_month[$key_finder2]/$divider);
                            if($months==$last_month) {
                                $week_for_comparision=($deliveries_per_month[$key_finder2]/$divider);
                            }
                    ...
                    if($total_deliveries_per_supplier>0) {
                        echo "<td>".round(($total_deliveries_per_supplier/$month_counter),2)."</td>";
                    }else {
                        echo "<td></td>";
                    ...
                    if ($five_week_total==0) {
                        ...
                        echo "<td >".number_format(($five_week_total/$current_month_divider),2)."</td>";
                    ...
                    echo "<td  class='TOTAL'>".round(($current_week-$week_for_comparision),2)."</td>";
                ...
                foreach($months_array as $var) {
                    ...
                    if(trim($filtering_grade)!='') {
                        ...
                        if($filtering_branch=='Sauyo/Kaybiga') {
                            $query31="SELECT sum(weight)/1000 as weight, month_delivered,year_delivered,date_delivered FROM sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status!='inactive' and  year_delivered='".$year."' and month_delivered ='$month'  and (branch_delivered ='Kaybiga' or branch_delivered ='Sauyo') ";
                        }else {
                            $query31="SELECT sum(weight)/1000 as weight, month_delivered,year_delivered,date_delivered FROM sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status!='inactive' and  year_delivered='".$year."' and month_delivered ='$month'  and branch_delivered like '%".$filtering_branch."%'  ";
                        }
                    }
                    ...
                    if($row31 = mysql_fetch_array($result31)) {
                        ...
                        $divider=((date("j", strtotime($end_of_the_month)))/7);
                        echo "<td class='TOTAL' >".round(($row31['weight']/$divider),2)."</td>";
                    }else {
                        echo "<td class='TOTAL' ></td>";
                    }
                }
                echo "<td class='TOTAL' ></td>";
                echo "<td class='TOTAL' >".round($current_month_total,2)."</td>";
                ...
                echo "<td class='TOTAL' ></td>";
                // echo "<td>$week_for_comparison_total</td>";
                echo "<td class='TOTAL' >".round($current_week_total-$week_for_comparison_total,2)."</td>";
                echo "<td class='TOTAL' ></td>";
                ?>
            </table>
    </div>
