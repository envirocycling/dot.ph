...
?>	
	...
	<div class="grid_10">
	 ...
	 <!-- -------------- ------------------------------ WEEKLY VIZMIN --------------------------------------------------------------------------->	
 <?php
 	//echo $myDatawtd_actualprice['LCWL']['VISAYAS'].' === '.@$myDatawtd_actualprice['LCWL']['MINDANAO'].'<br>';
	//echo @$myDatawtd_actualweight['LCWL']['VISAYAS'].' ----- '.@$myDatawtd_actualweight['LCWL']['MINDANAO'];
 ?>
