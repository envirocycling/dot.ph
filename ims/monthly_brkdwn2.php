    ...
    <div class="box round first grid">
        <h2><?php $ngayon=date('F d, Y');
            ...
            <table class="data display datatable" id="example">
                ...
                $query40="SELECT supplier_id,supplier_name,branch,classification FROM supplier_details ";
                ...
                $query21="SELECT  unit_cost,supplier_id FROM paper_buying where  wp_grade like '%".$_SESSION['weekly_wp_grade']."%' and date_received like '%".$remarks_date."%' and branch like '%".$_SESSION['weekly_branch']."%' order by date_received desc;";
                $result21=mysql_query($query21);
                ...
                while($row5 = mysql_fetch_array($result5)) {
                    ...
                    $pick_up_date=date("Y/m", strtotime($row5['date_delivered']));
                    $query51="SELECT sum(net_weight) FROM pick_up where wp_grade like '%".$_SESSION['weekly_wp_grade']."%' and supplier_name='".$row5['supplier_id']."' and date like '%$pick_up_date%';";
                    $result51 =mysql_query($query51);
                    if($row51 = mysql_fetch_array($result51)) {
                ...
                while($row3 = mysql_fetch_array($result3)) {
                    $pick_up=0;
                    $query51="SELECT sum(net_weight) FROM pick_up where wp_grade like '%".$_SESSION['weekly_wp_grade']."%' and supplier_name='".$row3['supplier_id']."' and date='".$row3['date_delivered']."';";
                    $result51 =mysql_query($query51);
                    if($row51 = mysql_fetch_array($result51)) {
                        $pick_up=$row51['sum(net_weight)'];
                    }
