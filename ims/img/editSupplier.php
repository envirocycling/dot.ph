...
<div class="grid_10">
    <div class="box round first fullpage">
        ...
        <div class="block ">
            <form action="editSupplierExec.php" method="POST">
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="bh_in_charge" class="mini" value="<?php echo $row['bh_in_charge'];?>" />
                        </td>
                    </tr>
                    <?php
                    $address_array=preg_split('[/]',$row['address']);
                    ?>
                    <tr>
                        <td>
                            <label>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="street_all" name="street" class="large" value="<?php echo $address_array[0]; ?>" placeholder="Street/Barangay"/>
                        </td>
                        <td>
                            <input type="text" id="municipality_all" name="municipality" class="large" value="<?php echo $address_array[1]; ?>" placeholder="Municipality"/>
                        </td>
                        <td>
                            <select id="province_all" name="province">
                                <option value="<?php echo $address_array[2]; ?>"><?php echo $address_array[2]; ?></option>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="street_ncr" name="street" class="large" value="<?php echo $address_array[0]; ?>" placeholder="Street/Barangay" disabled="true"/>
                        </td>
                        <td>
                            <input type="text" id="municipality_ncr" name="municipality" class="large" value="<?php echo $address_array[1]; ?>" placeholder="Municipality" disabled="true"/>
                        </td>
                        <td>
            ...
            <a id="view_history" href="viewDeliveryHistory.php?id=<?php echo $row['supplier_id']; ?>"><button>View Delivery History</button></a>
