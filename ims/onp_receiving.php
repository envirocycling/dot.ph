...
<div id="container" class="clear">
    <div id="content">
        ...
        $ngayon=date('m/d/y');
        echo "<h2> ONP Deliveries as of : <u><b><i>".$ngayon."</i></b></u></h2>";
        ...
        <table summary="Summary Here" cellpadding="0" cellspacing="0" border="2">
            ...
            $query="SELECT supplier_name,count(supplier_name) FROM sup_deliveries  where wp_grade='onp' and supplier_id like '".$_SESSION['supplier_id']."%' and branch_delivered like '%".$_SESSION['supplier_branch']."%' and supplier_name like '%".$_SESSION['supplier_name']."%' and branch_delivered like '%".$_SESSION['supplier_branch']."%' and supplier_type like '%".$_SESSION['supplier_type']."%'  and bh_in_charge like '".$_SESSION['bh_criteria']."%' group by supplier_name order by supplier_name asc,del_id asc;";
            ...
            $query3="SELECT supplier_id,del_id,supplier_name,sum(weight),month_delivered FROM sup_deliveries  where wp_grade='onp' and supplier_id like '".$_SESSION['supplier_id']."%' and branch_delivered like '%".$_SESSION['supplier_branch']."%' and supplier_name like '%".$_SESSION['supplier_name']."%'  and supplier_type like '%".$_SESSION['supplier_type']."%'  and  year_delivered ='".$_SESSION['yearcriteria']."'  and bh_in_charge like '".$_SESSION['bh_criteria']."%' group by supplier_name,month_delivered order by supplier_name asc,del_id asc;";
            ...
            echo "<tr id='total'>";
            echo "<td>TOTAL</td>";
            echo "<td>".number_format($january_total,2)."</td>";
            echo "<td>".number_format($february_total,2)."</td>";
            echo "<td>".number_format($march_total,2)."</td>";
            echo "<td>".number_format($april_total,2)."</td>";
            echo "<td>".number_format($may_total,2)."</td>";
            echo "<td>".number_format($june_total,2)."</td>";
            echo "<td>".number_format($july_total,2)."</td>";
            echo "<td>".number_format($august_total,2)."</td>";
            echo "<td>".number_format($september_total,2)."</td>";
            echo "<td>".number_format($october_total,2)."</td>";
            echo "<td>".number_format($november_total,2)."</td>";
            echo "<td>".number_format($december_total,2)."</td>";
