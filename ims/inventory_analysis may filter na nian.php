            ...
            <table class="data display datatable" id="example">
                ...
                foreach($wp_array as $wp_grade) {
                    ...
                    if($wp_grade!='LCWL' && $wp_grade!='CHIPBOARD'  && $wp_grade!='LCCB'  &&  $wp_grade  != 'chipboard' ) {
                        if($wp_grade =='LCMW') {
                            $query="SELECT wp_grade,sum(weight) from sup_deliveries where date_delivered like '%$month%' and  branch_delivered like '%$branch%'  and (wp_grade='$wp_grade2' or wp_grade='coretube') group by wp_grade";
                        }else {
                    ...
                    if($wp_grade!='LCWL' && $wp_grade!='CHIPBOARD'  && $wp_grade!='LCCB'  &&  $wp_grade  != 'chipboard' ) {
                        ...
                        if($wp_grade =='LCMW') {
                            $query="SELECT wp_grade,sum(net_weight) from pick_up where date like '%$month%' and branch='$branch'  and (wp_grade='$wp_grade2' or wp_grade='coretube')  group by wp_grade";
                        }else {
                            $query="SELECT wp_grade,sum(net_weight) from pick_up where date like '%$month%' and branch='$branch' and wp_grade='$wp_grade2' group by wp_grade";

                        }

                    }else {
                        if($wp_grade=='CHIPBOARD' || $wp_grade=='LCCB'  || $wp_grade =='chipboard') {
                            $query="SELECT wp_grade,sum(net_weight) from pick_up where date like '%$month%' and branch='$branch'  and (wp_grade='cb' or wp_grade='chipboard' or wp_grade='CHIPBOARD') group by wp_grade";
                        }else {
                            $query="SELECT wp_grade,sum(net_weight) from pick_up where date like '%$month%' and branch='$branch' and wp_grade='LCWL'  group by wp_grade";
                        }
                    }
                    ...
                    if($from =='') {
                        if($wp_grade!='LCWL' && $wp_grade!='CHIPBOARD'  && $wp_grade!='LCCB') {
                            $query3="SELECT wp_grade,sum(bale_weight) from bales where branch like '%$branch%'  and wp_grade='$wp_grade2'   and str_no=0  and wp_grade!='VOID' AND str_no NOT LIKE  '%DR%'  and status !='rebaled'  group by wp_grade";
                        }else {
                            if($wp_grade=='CHIPBOARD'  || $wp_grade=='LCCB') {
                                $query3="SELECT wp_grade,sum(bale_weight) from bales where  branch like '%$branch%'  and (wp_grade='cb' or wp_grade='chipboard')  and str_no =0   and wp_grade!='VOID' AND str_no NOT LIKE  '%DR%'  and status !='rebaled'  group by wp_grade";
                            }else {
                                $query3="SELECT wp_grade,sum(bale_weight) from bales where branch like '%$branch%'  and wp_grade='LCWL' and str_no =0    and wp_grade!='VOID'   AND str_no NOT LIKE  '%DR%'  and status !='rebaled'  group by wp_grade";
                            }
                        }
                    }else {

                        if($wp_grade!='LCWL' && $wp_grade!='CHIPBOARD'  && $wp_grade!='LCCB') {
                            $query3="SELECT wp_grade,sum(bale_weight) from bales where date like '%$month%' and branch like '%$branch%'  and wp_grade='$wp_grade2'   and str_no!='VOID'  and  (out_date > '$last_day_of_the_month' or out_date < '$first_day_of_the_month' or out_date=''  )   and (date_rebaled > '$last_day_of_the_month' or date_rebaled < '$first_day_of_the_month' or date_rebaled='')   group by wp_grade";
                        }else {
                            if($wp_grade=='CHIPBOARD'  || $wp_grade=='LCCB') {
                                $query3="SELECT wp_grade,sum(bale_weight) from bales where date like '%$month%' and  branch like '%$branch%'  and (wp_grade='cb' or wp_grade='chipboard')   and str_no!='VOID'  and  ((out_date > '$last_day_of_the_month' or out_date < '$first_day_of_the_month' or out_date='' ))   and (date_rebaled > '$last_day_of_the_month' or date_rebaled < '$first_day_of_the_month' or date_rebaled='')    group by wp_grade";
                            }else {
                                $query3="SELECT wp_grade,sum(bale_weight) from bales where date like '%$month%' and  branch like '%$branch%'  and wp_grade='LCWL'   and str_no!='VOID'  and  ((out_date > '$last_day_of_the_month' or out_date < '$first_day_of_the_month' or out_date='' ))   and (date_rebaled > '$last_day_of_the_month' or date_rebaled < '$first_day_of_the_month' or date_rebaled='')   group by wp_grade";
                            }
                        }
                    }
                    ...
                    if($wp_grade!='LCWL' && $wp_grade!='CHIPBOARD'  && $wp_grade!='LCCB') {
                        $query5="SELECT sum(weight) from outgoing where wp_grade='$wp_grade' and branch='$branch' and date like '%$month%'";
                    }else {
                        if($wp_grade=='CHIPBOARD'  || $wp_grade=='LCCB') {
                            $query5="SELECT sum(weight) from outgoing where (wp_grade='chipboard' or wp_grade='cb') and branch='$branch' and date like '%$month%'";
                        }else {
                            $query5="SELECT sum(weight) from outgoing where wp_grade='LCWL' and branch='$branch' and date like '%$month%'";
                        }
                    }
                    ...
                    if($wp_grade!='LCWL' && $wp_grade!='CHIPBOARD'  && $wp_grade!='LCCB') {
                        $query6="SELECT sum(weight) from actual where wp_grade='$wp_grade' and branch='$ts_diff_branch' and date like '%$month%' ";
                    }else {
                        if($wp_grade=='CHIPBOARD'  || $wp_grade=='LCCB') {
                            $query6="SELECT sum(weight) from actual where wp_grade='chipboard' and branch='$ts_diff_branch' and date like '%$month%'";
                        }else if ($wp_grade=='LCWL') {
                            $query6="SELECT sum(weight) from actual where wp_grade='lcwl' and branch='$ts_diff_branch' and date like '%$month%'";
                        }
                    }
                    ...
                    */
                    ...
                    if($from =='') {
                        if($wp_grade!='LCWL' && $wp_grade!='CHIPBOARD'  && $wp_grade!='LCCB' && $wp_grade !='lccb' && $wp_grade !='CB' && $wp_grade !='chipboard' && $wp_grade !='cb' && $wp_grade !='lcwl') {
                            $query6="SELECT wp_grade,count(wp_grade) from bales where wp_grade='$wp_grade2'  and str_no=0  and str_no not like '%DR%' and branch like '%$branch%'   and str_no!='VOID'  and status !='rebaled'   group by wp_grade";
                            ...
                            if($wp_grade=='chipboard' || $wp_grade=='cb' || $wp_grade=='CHIPBOARD'  || $wp_grade=='LCCB' ) {
                                $query6="SELECT wp_grade,count(wp_grade) from bales where (wp_grade='cb' or wp_grade='chipboard' or wp_grade ='CB' or wp_grade ='CHIPBOARD')    and str_no!='VOID'  and str_no not like '%DR%'   and str_no=0   and  branch like '%$branch%'  and status !='rebaled'  group by wp_grade";
                            }else {
                                $query6="SELECT wp_grade,count(wp_grade) from bales where (wp_grade='LCWL' or wp_grade='lcwl')  and str_no=0 and str_no not like '%DR%' and  branch like '%$branch%'    and str_no!='VOID'  and status !='rebaled'  group by wp_grade";
                            }
                        }
                    }else {
                        if($wp_grade!='LCWL' && $wp_grade!='CHIPBOARD'  && $wp_grade!='LCCB' && $wp_grade !='lccb' && $wp_grade !='CB') {
                            $query6="SELECT wp_grade,count(wp_grade) from bales where wp_grade='$wp_grade2' and  date like '%$month%' and ((out_date > '$last_day_of_the_month' or out_date < '$first_day_of_the_month' or out_date='' or str_no='0'))    and branch like '%$branch%'  and status !='rebaled'  group by wp_grade";
                        }else {
                            if($wp_grade=='CHIPBOARD'  || $wp_grade=='LCCB' || $wp_grade =='chipboard' || $wp_grade =='cb') {
                                $query6="SELECT wp_grade,count(wp_grade) from bales where (wp_grade='cb' or wp_grade='chipboard' or wp_grade ='CB' or wp_grade='CHIPBOARD')  and  date like '%$month%' and ((out_date > '$last_day_of_the_month' or out_date < '$first_day_of_the_month' or out_date='' or str_no='0'))  and str_no!='VOID' and  branch like '%$branch%'  and status !='rebaled'  group by wp_grade";
                            }else {
                                $query6="SELECT wp_grade,count(wp_grade) from bales where wp_grade='LCWL' and  date like '%$month%' and ((out_date > '$last_day_of_the_month' or out_date < '$first_day_of_the_month' or out_date='' or str_no='0'))    and str_no!='VOID'  and  branch like '%$branch%'  and status !='rebaled'  group by wp_grade";
                            }
                        }
                    }
