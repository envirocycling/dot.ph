...
<div class="grid_5">
    <div class="box round first grid">
        <h2>Paper Buying Summary</h2>
        <form action="paper_buying_summary.php" method="POST">
            <br>
            ...
            echo $dropdown;
            ?>
            Group: <select name="is_quota" value="">
                <option>all</option>
                <option>with quota only</option>
                <option>without quota only</option>
