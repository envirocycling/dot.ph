...
<div class="grid_10">
   ...
   // echo '<a rel="facebosx" href="form_delete_bm_prod.php?branch='.$_SESSION['selected_branch'].'"><button>Delete BM Prod </button></a>';
    echo '<a rel="facebosx" href="form_delete_bales.php?branch='.$_SESSION['selected_branch'].'"><input type="button" value="Delete Bales"></a>';
