                    ...
                    if ($_SESSION['usertype'] == 'RMD Supervisor') {
                        ...
                        <li class="ic-grid-tables"><a href=""><span>Accounting</span></a>
                            <ul>
                                ...
                                <li><a href="acctg_sales_deliveries.php">Sale / Deliveries</a></li>
                        ...
                        <li class="ic-grid-tables"><a href="javascript:"><span>Quota Monitoring</span></a>
                        ...
                        <ul>
                            ...
                            if ($usertype == 'Super User') {
                                ...
                                echo ' <li><a href="paper_buying_report_horizontal.php">New Report</a></li>';
                                echo ' <li><a href="tipco_multiply_billings.php">Tipco Multiply Billing</a></li>';
                                echo '<li><a href="price_change_report.php">Target & Performance</a></li>';
...
//                                echo '<li><a href="price_change_report3.php">Target & Performance III</a></li>';
                        ...
                        <ul>
                            ...
                            <?php
                            if ($usertype == 'Super User') {
//                                echo '<li><a href="rmd_data.php">RMD Data</a></li>';
								echo '<li><a href="deliveries_to_client_new.php">Testing</a></li>';
                                echo '<li><a href="deliveries_to_client.php">Deliveries to Client I</a></li>';
                                echo '<li><a href="deliveries_to_client2.php">Deliveries to Client II</a></li>';
