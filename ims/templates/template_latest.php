                    ...
                    if ($_SESSION['usertype'] == 'RMD Supervisor') {
                        ...
                        <li class="ic-grid-tables"><a href="javascript:"><span>Delivery Performance</span></a>
                            ...
                            <ul>
								...
								echo '<li><a href="target_performance_new.php">Testing Report (Luz&VizMin)</a></li>';
                                ?>
