...
<div id="body">
        ...
        $query="SELECT sum(weight),wp_grade FROM sup_deliveries where month_delivered='".$_SESSION['weekly_month']."' and year_delivered='".$_SESSION['weekly_year']."' group by wp_grade order by wp_grade asc";
...
<div id="body">
        ...
        $query="SELECT sum(weight),wp_grade FROM sup_deliveries where month_delivered='".$_SESSION['weekly_month']."' and year_delivered='".$_SESSION['weekly_year']."' and branch_delivered='".$_SESSION['user_branch']."' group by wp_grade order by wp_grade asc";
        $result=mysql_query($query);
