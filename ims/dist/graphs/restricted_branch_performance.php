...
$query="SELECT sum(weight),month_delivered FROM sup_deliveries where year_delivered ='".$_SESSION['weekly_year']."'  and branch_delivered = '".$_SESSION['user_branch']."' group by month_delivered order by date_delivered asc";
...
while($row = mysql_fetch_array($result)) {
    ...
    $query2="SELECT sum(net_weight) FROM pick_up where  date like '%$pick_up_date%' and branch = '".$_SESSION['user_branch']."';";
