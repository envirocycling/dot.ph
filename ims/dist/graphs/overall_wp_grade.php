...
$query="SELECT sum(weight),wp_grade FROM sup_deliveries where month_delivered='".$_SESSION['weekly_month']."' and wp_grade!='VOID' and year_delivered='".$_SESSION['weekly_year']."' group by wp_grade order by sum(weight) desc";
