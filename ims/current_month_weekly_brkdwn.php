        ...
        if($_SESSION['usertype']=='Super User') {
            ...
            ?> Month: <select name="weekly_month" onchange='this.form.submit()'>                <option value="<?php echo $_SESSION['weekly_month'];?>"><?php echo $_SESSION['weekly_month'];?></option>                <option value="January">January</option>                <option value="February">February</option>                <option value="March">March</option>                <option value="April">April</option>                <option value="May">May</option>                <option value="June">June</option>                <option value="July">July</option>                <option value="August">August</option>                <option value="September">September</option>                <option value="October">October</option>                <option value="November">November</option>                <option value="December">December</option>            </select>            Year: <select name="weekly_year" onchange='this.form.submit()'>                <option value="<?php echo $_SESSION['weekly_year'];?>"><?php echo $_SESSION['weekly_year'];?></option>                <option value="2011">2011</option>                <option value="2012">2012</option>                <option value="2013">2013</option>                <option value="2014">2014</option>                <option value="2015">2015</option>                <option value="2016">2016</option>                <option value="2017">2017</option>                <option value="2018">2018</option>                <option value="2019">2019</option>                <option value="2020">2020</option>            </select>            <?php            echo "</form><br>";            ?>                       <table class="data display datatable" id="example">
                ...
                if($_SESSION['weekly_branch']=='') {
                    $query="SELECT * FROM sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.status !='inactive' and year_delivered='".$_SESSION['weekly_year']."'  group by sup_deliveries.supplier_name";
                }else {
                    $query="SELECT * FROM sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.status !='inactive' and year_delivered='".$_SESSION['weekly_year']."' and branch_delivered ='".$_SESSION['weekly_branch']."' group by sup_deliveries.supplier_name";
                ...
                if($_SESSION['usertype']=='Super User') {
                    $query3="SELECT supplier_details.supplier_id as supplier_id,supplier_details.supplier_name as supplier_name,sum(weight),date_delivered FROM sup_deliveries  join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.status!='inactive' and month_delivered='".$_SESSION['weekly_month']."' and year_delivered='".$_SESSION['weekly_year']."' and wp_grade like '%".$_SESSION['weekly_wp_grade']."%' and branch_delivered like '%".$_SESSION['weekly_branch']."%' group by sup_deliveries.supplier_name,date_delivered";
                }else {
                    $query3="SELECT supplier_details.supplier_id as supplier_id,supplier_details.supplier_name as supplier_name,sum(weight),date_delivered FROM sup_deliveries join  supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.status!='inactive' and month_delivered='".$_SESSION['weekly_month']."' and year_delivered='".$_SESSION['weekly_year']."' and wp_grade like '%".$_SESSION['weekly_wp_grade']."%' and branch_delivered = '".$_SESSION['user_branch']."' group by sup_deliveries.supplier_name,date_delivered";
                }
                ...
                foreach ($branch_array as $value2) {
                    ...
                    echo "<td id='week'>".round($week1_total)."</td>";



                    echo "<td id='week'>".round($week2_total)."</td>";
                    ;


                    echo "<td id='week'>".round($week3_total)."</td>";

///////////////////////////////////////////////

                    echo "<td id='week'>".round($week4_total)."</td>";
                    ;
///////////////////////////////////////////////////

                    echo "<td id='week'>".round($week5_total)."</td>";
                    ...
                    echo "<td id='price'>".round($price,2)."</td>";
/////////////////////////////////////////////////////////////////
