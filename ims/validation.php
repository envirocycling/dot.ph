...
if ($checker > 0) {
    ...
    } else if($_SESSION['position'] == 'Tipco PLD' && $_SESSION['usertype'] == 'Tipco PLD') {

        header('Location:price_change_report.php');
    }else if($_SESSION['usertype'] == 'PSS') {
        header('Location: pss/index.php');
    }else {
