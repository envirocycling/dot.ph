...
//                    }
                  ...
                  if($nums != 0 ){  echo "<td>" . round($actual_array[$wp_grade])."</td>";
        ...
        <div class="box round first">
            ...
            <table class="data display datatable" id="example">
                ...
                foreach ($branch_del as $branch_name) {
                    ...
                    echo "<td>" . round($del_perf[$branch_name]['LCWL'] / 1000, 1) . "</td>";
                ...
                $total = $wl + $onp + $cbs + $mw + $chip + $occ;

                echo "<tr id='TOTAL'>";

                echo "<td>!TOTAL!</td>";

                echo "<td>" . round($total_per_grade['LCWL'] / 1000, 0) . "</td>";

                echo "<td>" . round(($total_per_grade['LCONP'] + $total_per_grade['LCOPD'] + $total_per_grade['LCNPB']) / 1000, 1) . "</td>";

                echo "<td>" . round($total_per_grade['LCCBS'] / 1000, 1) . "</td>";

                echo "<td>" . round($total_per_grade['LCOCC'] / 1000, 1) . "</td>";

                echo "<td>" . round(($total_per_grade['LCMW'] + $total_per_grade['LCMW-PPQ'] + $total_per_grade['LCAP_K'] + $total_per_grade['LCMW_S']) / 1000, 1) . "</td>";

                echo "<td>" . round($total_per_grade['CHIPBOARD'] / 1000, 1) . "</td>";
