...
//                    }
                ...
                if ($wp_grade == 'MW') {
                    ...
                    echo "(" . $actual_array[$wp_grade] . " + " . $actual_array['OCC_E'] . ") - " . $export_deliveries;
        ...
        <table class="data display datatable" id="example">
            ...
            <thead>
                ...
                foreach ($branch_del as $branch_name) {
                    ...
                    echo "<td>" . round(($del_perf[$branch_name]['LCOCC']+$del_perf[$branch_name]['LCOCC_E']) / 1000, 1) . "</td>";
                ...
                echo "<td>" . $occ+=round(($total_per_grade['LCOCC']+$total_per_grade['LCOCC_E']) / 1000, 1) . "</td>";
