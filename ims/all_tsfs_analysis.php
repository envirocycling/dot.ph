...
<div class="grid_10">
    <div class="box round first grid">
        ...
        echo "<h2> "."CONSOLIDATED"." TS and FS Variance Analysis as of : <u><b><i>".$ngayon."</i></b></u></h2>";
        ...
        <table class="data display datatable" id="example">
            ...
            echo "</thead>";
            include("config.php");
            $query="SELECT wp_grade,str,branch,trucking,date,plate_number,sum(weight) as weight FROM outgoing  group by str,wp_grade";
