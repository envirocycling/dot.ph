    ...
    <div class="box round first grid">
        <h2><?php
            ...
            <table class="data display datatable" id="example">
                ...
                if($filtering_branch=='Sauyo/Kaybiga') {
                    $query52="SELECT sum(weight),month_delivered,sup_deliveries.supplier_id as supplier_id,date_delivered,year_delivered from sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status!='inactive' and  day_delivered > 15 and date_delivered >='$start_date' and  date_delivered <='$breaker_date' and wp_grade like '%".$filtering_grade."%' and (branch_delivered ='Kaybiga' or branch_delivered ='Sauyo')  group by  supplier_id,month_delivered,year_delivered order by date_delivered";
                }else {
                    $query52="SELECT sum(weight),month_delivered,sup_deliveries.supplier_id as supplier_id,date_delivered,year_delivered from sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status!='inactive' and   day_delivered >15 and  date_delivered >='$start_date' and date_delivered <='$breaker_date' and wp_grade like '%".$filtering_grade."%' and branch_delivered like '%".$filtering_branch."%' group by  supplier_id,month_delivered,year_delivered order by date_delivered";
                }
                ...
                if(trim($filtering_grade)!='') {
                    ...
                    if($filtering_branch=='Sauyo/Kaybiga') {
                        $query3="SELECT sup_deliveries.supplier_id as supplier_id,sum(weight),date_delivered,month_delivered FROM sup_deliveries  join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status!='inactive 'and  month_delivered='$weekly_month' and year_delivered='$weekly_year'  and   (branch_delivered ='Kaybiga' or branch_delivered ='Sauyo') and date_delivered >= '$start_date' and date_delivered <='$breaker_date' group by supplier_id,date_delivered";
                    }else {
                        $query3="SELECT sup_deliveries.supplier_id as supplier_id,sum(weight),date_delivered,month_delivered FROM sup_deliveries  join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status!='inactive 'and  month_delivered='$weekly_month' and year_delivered='$weekly_year'  and branch_delivered like '%".$filtering_branch."%' and date_delivered >= '$start_date' and date_delivered <='$breaker_date' group by supplier_id,date_delivered";
                    }
                }
...
//////////////////////////////////
                ...
                if($filtering_branch=='Sauyo/Kaybiga') {
                    $query5="SELECT sum(weight),month_delivered,year_delivered from sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status!='inactive' and day_delivered<=15 and date_delivered >='$start_date' and  date_delivered <='$breaker_date' and wp_grade like '%".$filtering_grade."%' and (branch_delivered ='Kaybiga' or branch_delivered ='Sauyo')  group by  month_delivered,year_delivered order by date_delivered";
                }else {
                    $query5="SELECT sum(weight),month_delivered,year_delivered from sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status!='inactive' and  day_delivered<=15 and  date_delivered >='$start_date' and date_delivered <='$breaker_date' and wp_grade like '%".$filtering_grade."%' and branch_delivered like '%".$filtering_branch."%' group by  month_delivered,year_delivered order by date_delivered";
                }
                $result5 =mysql_query($query5);
                ...
                if($filtering_branch=='Sauyo/Kaybiga') {
                    $query53="SELECT sum(weight),month_delivered,year_delivered from sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status!='inactive' and   day_delivered > 15 and date_delivered >='$start_date' and  date_delivered <='$breaker_date' and wp_grade like '%".$filtering_grade."%' and (branch_delivered ='Kaybiga' or branch_delivered ='Sauyo')  group by  month_delivered,year_delivered order by date_delivered";
                }else {
                    $query53="SELECT sum(weight),month_delivered,year_delivered from sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id where supplier_details.inter_branch='0' and supplier_details.status!='inactive' and    day_delivered > 15 and  date_delivered >='$start_date' and date_delivered <='$breaker_date' and wp_grade like '%".$filtering_grade."%' and branch_delivered like '%".$filtering_branch."%' group by  month_delivered,year_delivered order by date_delivered";
                }
