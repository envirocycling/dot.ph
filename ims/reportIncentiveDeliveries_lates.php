...
<input type="button" value="Print" onClick="print();" class="noprint">
    <?php
	...
	if($sup_id == '12373' || $sup_id == '12366' || $sup_id == '1626' || $sup_id == '13313'){
		echo '<input type="text" value="1" id="con">';
	}else{
		echo '<input type="text" value="0" id="con">';
	}
