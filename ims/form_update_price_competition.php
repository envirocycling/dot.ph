...
$query = "SELECT * FROM pricing_against_competitors WHERE branch_affected='$company' group by company";
$result = mysql_query($query);
echo "Company:";
$dropdown = "<select name='company' id='combobox' required>";
...
echo "<span id='paliit'>";
echo $dropdown;
echo "<br><a href='form_update_price_competition_new.php'>New Company?</a><br>";
echo "</span>";
