...
$query="SELECT sum(actual.weight),actual.branch,target from actual join target_per_month on target_per_month.branch_name=actual.branch  where month ='$month' group by actual.branch;";
...
echo "<th>Target</th>";
echo "<th>Actual</th>";
$query="SELECT sum(actual.weight),branch,target from actual join target_per_month on target_per_month.branch_name=actual.branch  where month ='$month' group by actual.branch;";
$result=mysql_query($query);
