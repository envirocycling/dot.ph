...
<div class="grid_50" >
    <div class="box round first grid">
        <h2><?php $ngayon=date('F d, Y');
            ...
            echo "WP Grade:";
            $dropdown = "<td><select name='wp_grade' >";
            ...
            echo "Branch:";
            $dropdown = "<td><select name='branch' >";
            ...
            ?> Month: <select name="weekly_month" >
            ...
            <table class="data display datatable" id="example">
                ...
                if($_SESSION['weekly_branch']!='Sauyo/Kaybiga') {
                    $query40="SELECT * from supplier_details where status !='inactive' and branch like '%".$_SESSION['weekly_branch']."%' " ;

                }else {
                    $query40="SELECT * from supplier_details where status !='inactive' and branch ='Sauyo' or branch='Kaybiga' " ;
                ...
                while($row5 = mysql_fetch_array($result5)) {
                    $deliveries_per_month[$row5['supplier_id']."+".ucfirst(strtolower($row5['month_delivered']))]=(($row5['sum(weight)'])/1000);
                ...
                if($_SESSION['weekly_branch']=='Sauyo/Kaybiga') {
                    ...
                    $query="SELECT supplier_id FROM supplier_details where  status!='inactive' and  branch like '%".$_SESSION['weekly_branch']."%'   ";
                ...
                foreach ($supplier_array as $value2) {
                    ...
                    if(!empty($supplier_details_array[$value2])) {
                        ...
                        echo "<td id='left_header'><img src='icon/bura.png' name='$value2' onclick='hideSupplier(this.name);' ></td>";
                        ...
                        if($supplier_details[2]!='') {
                            echo "<td id='weekly'>".$supplier_details[2]."</i></u></button></td>";
                        }else {
...
/////////////////////////////////////////////////////////////////////////////////////////////
                    foreach($months_array as $months) {
                        ...
                        if(!empty($deliveries_per_month[$key_finder2])) {
                            ...
                            echo "<td>".$deliveries_per_month[$key_finder2]."</td>";
                        }
                        else {
                            echo "<td></td>";
                        }
...
////////////////////----Weekly Breakdown----//////////////////////////////////////////////////////
                    if(round($week1_total+$week2_total+$week3_total+$week4_total+$week5_total+0,2)==0) {
                        ...
                        echo "<td class='TOTAL'>".$total_current_month."</td>";
...
/////////////////////////////////////////////
                ...
                foreach($months_array as $month) {
                    if(trim($_SESSION['weekly_wp_grade'])!='') {
                        if($_SESSION['weekly_branch']=='Sauyo/Kaybiga') {
                            $query31="SELECT sum(weight)/1000 as weight,month_delivered FROM sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id  where  supplier_details.status!='inactive' and  wp_grade='".$_SESSION['weekly_wp_grade']."' and year_delivered='".$_SESSION['weekly_year']."' and month_delivered ='$month' and   (branch_delivered ='Kaybiga' or branch_delivered ='Sauyo')  ";
                        }else {
                            $query31="SELECT sum(weight)/1000 as weight, month_delivered FROM sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id  where  supplier_details.status!='inactive' and  wp_grade='".$_SESSION['weekly_wp_grade']."' and year_delivered='".$_SESSION['weekly_year']."' and month_delivered ='$month' and branch_delivered like '%".$_SESSION['weekly_branch']."%'  ";

                        }
                    }else {
                        if($_SESSION['weekly_branch']=='Sauyo/Kaybiga') {
                            $query31="SELECT sum(weight)/1000 as weight,month_delivered FROM sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id  where  supplier_details.status!='inactive' and year_delivered='".$_SESSION['weekly_year']."' and month_delivered ='$month'  and (branch_delivered ='Kaybiga' or branch_delivered ='Sauyo') ";

                        }else {
                            $query31="SELECT sum(weight)/1000 as weight,month_delivered FROM sup_deliveries join supplier_details on sup_deliveries.supplier_id=supplier_details.supplier_id  where  supplier_details.status!='inactive' and year_delivered='".$_SESSION['weekly_year']."' and month_delivered ='$month'  and branch_delivered like '%".$_SESSION['weekly_branch']."%'  ";
