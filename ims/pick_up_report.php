...
<div class="grid_10">
    <div class="box round first grid">
        ...
        echo "<h2> ".$_SESSION['pick_up_branch']." PICK UP DELIVERIES as of : <u><b><i>".$_SESSION['pick_up_date']."</i></b></u></h2>";
        ?>
        <table class="data display datatable" id="example">
            ...
            echo "</thead>";
            include("config.php");
            $query="SELECT * from pick_up where branch='$branch' and date like '%".$_SESSION['pick_up_date']."%' ";
            ...
            while($row = mysql_fetch_array($result)) {
                ...
                echo "<td>".number_format($row['estimated_weight'],2)."</td>";
                echo "<td>".number_format($row['net_weight'],2)."</td>";
                echo "<td>".$row['variance']."</td>";

                echo "<td>".number_format($row['mc_percentage'],2)."</td>";
