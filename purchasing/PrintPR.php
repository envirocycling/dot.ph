...
<html>
    <body>
        <div id="container">
            ...
            echo "<input type='text'name='cost_1' id='cost_1' value='" . $row['cv3_1'] . "' size=12 readonly>";
            echo "<input type='text'name='cost_2' id='cost_2' value='" . $row['cv3_2'] . "' size=12 readonly>";
            echo "<input type='text'name='cost_3' id='cost_3' value='" . $row['cv3_3'] . "' size=12  readonly>";
            echo "<input type='text'name='cost_4' id='cost_4' value='" . $row['cv3_4'] . "' size=12 readonly>";
            echo "<input type='text'name='cost_5' id='cost_5' value='" . $row['cv3_5'] . "' size=12 readonly>";
            echo "<input type='text'name='cost_6' id='cost_6' value='" . $row['cv3_6'] . "' size=12 readonly>";
            echo "<input type='text'name='cost_7' id='cost_7' value='" . $row['cv3_7'] . "' size=12 readonly>";
            echo "<input type='text'name='cost_8' id='cost_8' value='" . $row['cv3_8'] . "' size=12 readonly>";
            echo "<input type='text'name='cost_9' id='cost_9' value='" . $row['cv3_9'] . "' size=12 readonly>";
            echo "<input type='text'name='cost_10' id='cost_10' value='" . $row['cv3_10'] . "' size=12 readonly>";
            echo "<input type='text'name='cost_11' id='cost_11' value='" . $row['cv3_11'] . "' size=12 readonly>";
            echo "<input type='text'name='cost_12' id='cost_12' value='" . $row['cv3_12'] . "' size=12 readonly>";
            ...
            if ($row['date_verified'] != '') {
                echo "<input type='text' name='verified'  id='verified' value='" . $row['verified'] . " - " . date("F d, Y", strtotime($row['date_verified'])) . "' size=20 readonly>";
            } else {
                echo "<input type='text' name='verified'  id='verified' value='" . $row['verified'] . "' size=20 readonly>";
            }
            if ($row['date_approved'] != '') {
                echo "<input type='text' name='approved'  id='approved' value='" . $row['approved'] . " - " . date("F d, Y", strtotime($row['date_approved'])) . "' size=20 readonly><br>";
            } else {
                echo "<input type='text' name='approved'  id='approved' value='" . $row['approved'] . "' size=20 readonly><br>";
            }
            ...
            ?>
            <?php
            if ($status == 'served' || $status == 'approved' && ($row['type'] == 'for approval' || $row['type'] == 'for_sample' || $row['type'] == 'heavy_vehicles')) {
