...
if (mysql_query("INSERT INTO fund_req (date_submitted,payee,accnt_no,amount,date_of_check,breakdown,prepared_by,audited_by,approved_by,submitted_by,branch_submitted,attachment,attachment2,attachment3)
                          VALUES('" . $_POST['date_submitted'] . "','" . $_POST['payee'] . "','" . $_POST['accnt_no'] . "','" . $_POST['amount'] . "','" . $_POST['date_of_check'] . "','" . $_POST['breakdown'] . "','" . $_POST['prepared_by'] . "','" . $_POST['audited_by'] . "','" . $_POST['approved_by'] . "','" . $_POST['submitted_by'] . "','" . $_SESSION['branch'] . "','$attachment','$attachment2','$attachment3')")) {
    echo "<script>";
