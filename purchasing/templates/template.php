            ...
            <div class="grid_12">
                <ul class="nav main">
                    ...
                    if($_SESSION['user_type'] == 'view'){
                        echo '<ul class="select"><li><a href="prRequests_mecha.php"><b>View PR</b></a></li></ul>';
                    }else  if ($_SESSION['username'] == 'lonlon') {
               ...
               <ul class="select"><li><a href="fund_requisition.php"><b>Fund Requisition</b></a></li></ul>
			     <ul class="select"><li><a href="users.php"><b>Users</b></a></li></ul>';
						...
						echo '<ul class="select"><li class = "ic-dashboard"><li><a href = "prRequests_afr.php"><b>PRequests</b></a></li></ul>';
...
//                        }
                        ...
                        echo '<li class="ic-dashboard"><a href="hrPending.php"><b>Pending </b></a></li>';
                        echo '<li class="ic-dashboard"><a href="formPR.php"><b>Send PR</b></a></li>';
                        echo '<ul class="select"><li><a href="hrRequests.php"><b>Request</b></a></li></ul>';
...
//                        echo '<ul class = "select"><li><a href = "fund_requisition.php"><b>Fund Requisition</b></a></li></ul>';
                    ...
                    } else if ($_SESSION['username'] == 'canvasser' || $_SESSION['username'] == 'ron') {

                        echo '<li class = "ic-dashboard"><a href = "canvassing_home.php"><b>Home</b></a></li>
                        <li class = "ic-dashboard"><a href = "formPR.php"><b>Send PR</b></a></li>
                        <li class = "ic-dashboard"><li><a href = "canvasser_mechanic_pending.php"><b>Queued to Mechanic</b></a></li>
                        ...
                        <li><a href = "new_check_requisition.php"><b>Payment Requisition</b></a></li>';

                    }else if($_SESSION['username'] == 'pampanga_purchaser') {
                        echo '
                        ...
                        <li class = "ic-dashboard"><li><a href = "forBHApproval.php?usertype=BH"><b>Queued to BH</b></a></li>
                        <li class = "ic-dashboard"><li><a href = "forBHApproval.php?usertype=HR"><b>Queued to HRD</b></a></li>
                        <li class = "ic-dashboard"><li><a href = "prRequests.php"><b>Queued to Mgmt.</b></a></li>
                        ...
                        <ul class = "select"><li><a href = "new_check_requisition.php"><b>Payment Requisition</b></a></li></ul>
...
//                        <ul class="select"><li><a href="fund_requisition.php"><b>Fund Requisition</b></a></li></ul>';
					...
					if($_SESSION['username'] == 'acd' || $_SESSION['username'] == 'msa'){
