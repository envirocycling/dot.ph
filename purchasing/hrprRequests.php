...
<div class="grid_10">
    <div class="box round first">
        ...
        <table class="data display datatable" id="example">
            ...
            include("config.php");
            $query = "SELECT * FROM requests WHERE (type!='office supplies' or type!='for hr') and (status ='approved by HR' or status ='approved') and (desc1 LIKE '%safety shoes%' or desc2 LIKE '%safety shoes%' or desc3 LIKE '%safety shoes%' or desc4 LIKE '%safety shoes%' or desc5 LIKE '%safety shoes%' or desc6 LIKE '%safety shoes%' or desc7 LIKE '%safety shoes%' or desc8 LIKE '%safety shoes%' or desc9 LIKE '%safety shoes%' or desc10 LIKE '%safety shoes%' or desc11 LIKE '%safety shoes%' or desc12 LIKE '%safety shoes%')order by request_id desc , status desc";
