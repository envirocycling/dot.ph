...
<html>
    <body>
        <div id="container">
            ...
            echo "<input type='text' name='verified' id='verified' value='" . $row['verified'].' '.date('M d, Y') . "' size=20 readonly>";
            echo "<input type='text' name='approved' id='approved' value='" . $row['approved'].'-'.$row_approver['fullname'].' '.date('M d, Y') . "' size=30 readonly><br>";
            ...
            <A HREF="javascript:void(0)"
               ...
               ?>
                   ...
                   if ($status == 'approved' && $row['new'] == '1') {

                       echo '<img src="signatures/' . $row['approved'] . '.jpg" id="signature" width=200 height=80>';
                   }
                   if ($row['verified_signature'] != '') {
                       echo "<img src='signatures/" . $row['verified_signature'] . ".jpg' id='bh_signature' width=200 height=80>";
                   }

                   echo '<a href="http://pdfcrowd.com/url_to_pdf/?height=-1"><button>Print</button></a>';



                   echo'<br><a href=hrApprovePR.php?request_id=' . $request_id . '><button>' . 'Approve PR' . '</button></a><br>';
