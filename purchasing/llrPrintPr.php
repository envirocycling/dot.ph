...
<span id="comments">
<?php
echo '<iframe src="commentutil/demo.php?request_id=' . $request_id . '" height="200%" width="600" frameBorder="0"></iframe>';
?>
</span>
<span id="llrPanel">
    <?php
    if ($row['type'] == 'for_sample' || $row['stamp'] != '' || $row['type'] == 'heavy_vehicles') {
        echo'<a href=stamp_pr.php?request_id=' . $request_id . '&action=approved><button>' . 'Approve but require canvass' . '</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
        echo'<a href=stamp_pr.php?request_id=' . $request_id . '&action=denied><button>' . 'Mark as denied' . '</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';

        echo "<hr>";
    }
    echo'<a href=llrApprovePR.php?request_id=' . $request_id . '><button>' . 'Approve PR' . '</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
    echo'<a href=disApprovePR.php?request_id=' . $request_id . '><button>' . 'Disapprove PR' . '</button></a>';
    echo'<a href=llrRequests.php><button>' . "Back to List" . '</button></a>';
    ?>
