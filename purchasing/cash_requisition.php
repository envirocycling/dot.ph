...
<div class="grid_10">
    <div class="box round first">
        ...
        <table class="data display datatable" id="example">
            <a href="frm_cash_req.php"> <button>Submit New</button></a><br>
            <?php
            ...
            if($_SESSION['username']=='lonlon') {
                ...
                if($_SESSION['check_req_status']=='pending') {
                    $query="SELECT * FROM cash_req where audited_signature='' and approved_signature=''";
                    ...
                    $query="SELECT * FROM cash_req ";
                }

            }else {
                if($_SESSION['authority']=='signatory') {
                    if($_SESSION['check_req_type']=='all_me') {
                        $query="SELECT * FROM cash_req where (audited_by='".$_SESSION['name']."' and audited_signature='' ) or (approved_by='".$_SESSION['name']."' and approved_signature='') ";
                    }else if($_SESSION['check_req_type']=='to_be_audited') {
                        $query="SELECT * FROM cash_req where (audited_by='".$_SESSION['name']."' and audited_signature='' ) ";
                    }else if($_SESSION['check_req_type']=='to_be_approved') {
                        $query="SELECT * FROM cash_req where (approved_by='".$_SESSION['name']."' and approved_signature='' ) ";
                    }else if($_SESSION['check_req_type']=='approved') {
                        $query="SELECT * FROM cash_req where (approved_by='".$_SESSION['name']."' and approved_signature!='' ) ";
                    }else if($_SESSION['check_req_type']=='audited') {
                        $query="SELECT * FROM cash_req where (audited_by='".$_SESSION['name']."' and audited_signature!='' ) ";
                    ...
                    if($_SESSION['check_req_status']=='pending') {
                        $query="SELECT * FROM cash_req where branch_submitted='".$_SESSION['branch']."' and audited_signature='' and approved_signature=''";
                    }else  if($_SESSION['check_req_status']=='audited') {
                        $query="SELECT * FROM cash_req where branch_submitted='".$_SESSION['branch']."'  and audited_signature!='' and approved_signature=''";
                    }else  if($_SESSION['check_req_status']=='approved') {
                        $query="SELECT * FROM cash_req where branch_submitted='".$_SESSION['branch']."'  and audited_signature='' and approved_signature!=''";
                        ...
                        $query="SELECT * FROM cash_req where branch_submitted='".$_SESSION['branch']."'";
                    }
                }
            }
            ...
            while($row = mysql_fetch_array($result)) {
                ...
                echo "<td><a href='view_cash_req.php?check_req_id=".$row['log_id']."'><button>View</button></a>
                    <a href='delete_cash_req.php?check_req_id=".$row['log_id']."'><button>Delete</button></a>
