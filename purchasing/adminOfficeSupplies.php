...
<div class="grid_10">
    <div class="box round first">
        ...
        <a href="adminOfficeSuppliesMonitor.php"><button>Check Monthly Consumption</button></a>
        <table class="data display datatable" id="example">
            ...
            include("config.php");
            $query="SELECT * FROM requests where type='office supplies' and (status = 'pending' or status='approved') order by status desc";
            ...
            while($row = mysql_fetch_array($result)) {
                ...
                echo "</form>";
                echo'<a href=printPR.php?request_id=' . $row["request_id"] . '><button>' . 'View PR' . '</button></a><br>';
