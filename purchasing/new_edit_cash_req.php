...
@session_start();
include("config.php");
$sql = mysql_query("SELECT * FROM cash_req WHERE log_id='" . $_GET['check_req_id'] . "'");
...
<center>
    <form action="new_submit_edit_cashreq.php" method="POST" enctype='multipart/form-data'>
        ...
        <table class="form">
            ...
            <tr>
                ...
                <td>
                    ...
                    echo "<option value='" . $rs['audited_by2'] . "'>" . $rs['audited_by2'] . "</option>";
                    while ($row = mysql_fetch_array($result)) {
                        echo "<option value='" . $row['name'] . "'>" . $row['name'] . " - " . $row['fullname'] . "</option>";
                    }
                    echo "</select>";
            ...
            <tr>
                ...
                <td>
                    <?php
                    $result = mysql_query("SELECT * FROM users where authority='signatory' and position='General Manager'");
