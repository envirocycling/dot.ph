...
<div class="grid_10">
    <div class="box round first">
        ...
        <table class="data display datatable" id="example">
            ...
            include("config.php");
            $query="SELECT * FROM requests where verified_signature='".$_SESSION['name']."' and status !='cancelled' ";
            ...
            while($row = mysql_fetch_array($result)) {
                ...
                echo'<td class="data"><a  href=printPR.php?request_id=' . $row["request_id"] . '><button>' . 'View' . '</button><a href="cancel.php?request_id=' . $row["request_id"] . '"><button>' . 'Cancel' . '</button></a></a>';
