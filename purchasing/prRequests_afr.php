    ...
    <div class="box round first">
        ...
        <form action="" method="POST">
            ...
            <option value='' disabled="disabled" selected="selected">Please Select</option>
                    <option value='pending to Allen'>Pending</option>
					<option value='pending'>Pending to LLR</option>
                    <option value='served'>Served</option>
                    <option value='Delivered'>Delivered</option>
                    <option value='approved'>LLR Approved</option>
        ...
        <table class="data display datatable" id="example">
            ...
            include("config.php");
			 ...
			 if (isset($_POST['submit'])) {
                $sql = mysql_query("SELECT * FROM requests WHERE status='" . $_POST['status'] . "'    order by request_id desc , status desc");
            } else { $sql = mysql_query("SELECT * FROM requests WHERE status='pending to cris'    order by request_id desc , status desc");}
