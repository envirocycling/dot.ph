    ...
    <div class="box round first">
        ...
        <table class="data display datatable" id="example">
            ...
            include("config.php");
			 ...
			 if (isset($_POST['submit'])) {
                $sql = mysql_query("SELECT * FROM requests WHERE status LIKE '" . $_POST['status'] . "%' and type = 'heavy_vehicles'   order by request_id desc , status desc");
            } else { $sql = mysql_query("SELECT * FROM requests WHERE status LIKE '%pending%'   and type = 'heavy_vehicles'   order by request_id desc , status desc");}
