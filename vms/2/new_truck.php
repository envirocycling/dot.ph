                    ...
                    <form id="defaultForm" method="post" class="form-horizontal" action="save_new_truck.php">
                        <table width="100%" align="center">
                            ...
                            <tr>
                                ...
                                <td> 
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Manage By<span class="required">*</span></label>
                                        <div class="col-sm-5">
                                            <select name="manageby" class='form-control'>
                                                <option value="Supplier Manage">Supplier</option>
                                                <option value="EFI Manage">EFI</option>
                                            </select>
                                        </div>
                                    </div>
                                </td>
