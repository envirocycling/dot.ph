...
<div id='cssmenu'>
    ...
    <ul>
        ...
        <?php if ($username != 'Xcellent'): ?>
        <li class='has-sub <?php echo $vehicle; ?>'><a><span>Vehicle</span></a>
            <ul>
                <li class='has-sub'><a>New Vehicle</a>
                    <ul>
                        <li><a href='new_truck.php?page=vehicle'><span>Truck</span></a></li>
                        <!-- <li class='has-sub'><a>Heavy Equipment</a>
                            <ul>
                                <li><a>Fork Lift</a></li>
                                <li><a>Bell Lift</a></li>
                                <li><a>PayLoader</a></li>
                        ...
                        <!-- <li><a>Heavy Equipment</a></li> -->
                        <li><a href='new_bm.php?page=vehicle'>Baling Machine</a></li>
                    </ul>
                </li>

                <!-- <li class=><a href='new_truck.php?page=vehicle'><span>New Vehicle</span></a></li> -->
                <li class='has-sub'><a><span>Existing Vehicles</span></a>
                    <ul>
                        <li><a href='existing_truck.php?page=vehicle'><span>Truck</span></a></li>
                        <!-- <li><a href="#"><span>Heavy Equipment</span></a></li> -->
                        <li><a href="existing_bm.php?page=vehicle"><span>Baling Machine</span></a></li>
                    </ul>
                </li>
            </ul>
        </li>
