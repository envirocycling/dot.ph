                            ...
                            <td>
                                <table  class="data display datatable">    
                                    ...
                                    if (!isset($_POST['submit'])) {
                                        $sql_truckRequest = mysql_query("SELECT * from tbl_truckrequest WHERE status LIKE '%pending%' and  branch LIKE '" . $_SESSION['owner'] . "'") or die(mysql_error());
                                    } else {
                                        $sql_truckRequest = mysql_query("SELECT * from tbl_truckrequest WHERE status LIKE '%" . $_POST['status'] . "%' and branch LIKE '" . $_SESSION['owner'] . "'") or die(mysql_error());
                                    }
