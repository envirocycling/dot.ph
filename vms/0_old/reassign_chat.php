...
$user = mysql_query("Select * from tbl_users Where username='".$_SESSION['username']."'  ") or die (mysql_error());
$user_row = mysql_fetch_array($user);

$tid = mysql_query("Select * from tbl_chat Where tid='".$_GET['id']."' Order by id Asc") or die(mysql_error());
