...
?>
 <?php $tbltire_select3 = mysql_query("Select * from tbl_trucktires Where truckplate= '".$_GET['id']."' And tireid='3'") or die(mysql_error());
		...
		?>
         <?php $tbltire_select7 = mysql_query("Select * from tbl_trucktires Where truckplate= '".$_GET['id']."' And tireid='7'") or die(mysql_error());
		$tbltire_row7 = mysql_fetch_array($tbltire_select7);
		
		$tblswaptire_select7 = mysql_query("Select * from tbl_changeswaps Where tireid='7' And truckid='".$_GET['id']."' And remarks='swap' Order by id Desc LIMIT 1") or die(mysql_error());
		$tblswaptire_row7 = mysql_fetch_array($tblswaptire_select7);
		
		$tblswap_select7= mysql_query("Select * from tbl_changeswaps Where swapto='7' And truckid='".$_GET['id']."' And remarks='swap' Order by id Desc LIMIT 1") or die(mysql_error());
			$tblswap_row7 = mysql_fetch_array($tblswap_select7);
	
		?>
          <?php $tbltire_select8 = mysql_query("Select * from tbl_trucktires Where truckplate= '".$_GET['id']."' And tireid='8'") or die(mysql_error());
		$tbltire_row8 = mysql_fetch_array($tbltire_select8);
		
		$tblswaptire_select8 = mysql_query("Select * from tbl_changeswaps Where tireid='8' And truckid='".$_GET['id']."' And remarks='swap' Order by id Desc LIMIT 1") or die(mysql_error());
		$tblswaptire_row8 = mysql_fetch_array($tblswaptire_select8);
		
		$tblswap_select8= mysql_query("Select * from tbl_changeswaps Where swapto='8' And truckid='".$_GET['id']."' And remarks='swap' Order by id Desc LIMIT 1") or die(mysql_error());
			$tblswap_row8 = mysql_fetch_array($tblswap_select8);
	
		?>
         <?php $tbltire_select9 = mysql_query("Select * from tbl_trucktires Where truckplate= '".$_GET['id']."' And tireid='9'") or die(mysql_error());
		$tbltire_row9 = mysql_fetch_array($tbltire_select9);
		
		$tblswaptire_select9 = mysql_query("Select * from tbl_changeswaps Where tireid='9' And truckid='".$_GET['id']."' And remarks='swap' Order by id Desc LIMIT 1") or die(mysql_error());
		$tblswaptire_row9 = mysql_fetch_array($tblswaptire_select9);
		
		$tblswap_select9= mysql_query("Select * from tbl_changeswaps Where swapto='9' And truckid='".$_GET['id']."' And remarks='swap' Order by id Desc LIMIT 1") or die(mysql_error());
			$tblswap_row9 = mysql_fetch_array($tblswap_select9);
	
		?>
         <?php $tbltire_select10 = mysql_query("Select * from tbl_trucktires Where truckplate= '".$_GET['id']."' And tireid='10'") or die(mysql_error());
		$tbltire_row10 = mysql_fetch_array($tbltire_select10);
		
		$tblswaptire_select10 = mysql_query("Select * from tbl_changeswaps Where tireid='10' And truckid='".$_GET['id']."' And remarks='swap' Order by id Desc LIMIT 1") or die(mysql_error());
		$tblswaptire_row10 = mysql_fetch_array($tblswaptire_select10);
		
		$tblswap_select10= mysql_query("Select * from tbl_changeswaps Where swapto='10' And truckid='".$_GET['id']."' And remarks='swap' Order by id Desc LIMIT 1") or die(mysql_error());
			$tblswap_row10 = mysql_fetch_array($tblswap_select10);
...
#tireforprint-13 {
	position:absolute;
	background-image:url(../tireprint/images/tireforprint_13.gif);
	left:323px;
	top:254px;
	width:115px;
	height:16px;
...
#tireforprint-16 {
	position:absolute;
	background-image:url(../tireprint/images/tireforprint_16.gif);
	left:640px;
	top:254px;
	width:90px;
	height:16px;
...
#tireforprint-19 {
	position:absolute;
	background-image:url(../tireprint/images/tireforprint_19.gif);
	left:941px;
	top:254px;
	width:97px;
	height:16px;
...
#tireforprint-66 {
	position:absolute;
	left:516px;
	background-image:url(../tireprint/images/tireforprint_66.gif);
	top:409px;
	width:98px;
	height:19px;
}
...
#tireforprint-74 {
	position:absolute;
	left:262px;
	background-image:url(../tireprint/images/tireforprint_74.gif);
	top:411px;
	width:81px;
	height:19px;
}
...
#tireforprint-77 {
	position:absolute;
	left:804px;
	background-image:url(../tireprint/images/tireforprint_77.gif);
	top:411px;
	width:100px;
	height:17px;
}
...
#tireforprint-78 {
	position:absolute;
	background-image:url(../tireprint/images/tireforprint_78.gif);
	left:1050px;
	top:411px;
	width:98px;
	height:17px;
...
#tireforprint-138 {
	position:absolute;
	background-image:url(../tireprint/images/tireforprint_138.gif);
	left:244px;
	top:564px;
	width:99px;
	height:17px;
...
#tireforprint-140 {
	position:absolute;
	background-image:url(../tireprint/images/tireforprint_140.gif);
	left:513px;
	top:564px;
	width:101px;
	height:17px;
...
#tireforprint-144 {
	position:absolute;
	background-image:url(../tireprint/images/tireforprint_144.gif);
	left:804px;
	top:564px;
	width:100px;
	height:17px;
...
#tireforprint-146 {
	position:absolute;
	background-image:url(../tireprint/images/tireforprint_146.gif);
	left:1050px;
	top:564px;
	width:98px;
	height:17px;
		...
		if(mysql_num_rows($tbltire_select1) == 0 && mysql_num_rows($tblswaptire_select1) == 0 && mysql_num_rows($tblswap_select1) == 0){
			...
			echo $tblswap_row1['tiresize'];
				...
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['tiresize'];
		}else if(mysql_num_rows($tbltire_select1) > 0){
				 echo $tbltire_row1['tiresize'];
			}	?>
	</font>
	...
	<div id="tireforprint-22">
	  <font size="-1">
		...
		if(mysql_num_rows($tbltire_select1) == 0 && mysql_num_rows($tblswaptire_select1) == 0 && mysql_num_rows($tblswap_select1) == 0){
			...
			echo $tblswap_row1['description'];
			}else if(mysql_num_rows($tblswaptire_select1) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row1['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['description'];
		}else if(mysql_num_rows($tbltire_select1) > 0){
				 echo $tbltire_row1['description'];
			}	?>
	</font>
	</div>
	...
	<div id="tireforprint-24">
     <font size="-1"><?php
		if(mysql_num_rows($tbltire_select11) == 0 ){
			...
			echo $tbltire_row11['description'];}
	...
	<div id="tireforprint-26">
      <font size="-1">
		...
		if(mysql_num_rows($tbltire_select2) == 0 && mysql_num_rows($tblswaptire_select2) == 0 && mysql_num_rows($tblswap_select2) == 0){
			...
			echo $tblswap_row2['description'];
			}else if(mysql_num_rows($tblswaptire_select2) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row2['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['description'];
		}else if(mysql_num_rows($tbltire_select2) > 0){
				 echo $tbltire_row2['description'];
			}	?>
	</font>
	</div>
...
$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswap_row2['tireid']."'") or die(mysql_error());
	...
	<div id="tireforprint-79">
     <font size="-1">
		...
		if(mysql_num_rows($tbltire_select4) == 0 && mysql_num_rows($tblswaptire_select4) == 0 && mysql_num_rows($tblswap_select4) == 0){
			...
			echo $tblswap_row4['descripton'];
			}else if(mysql_num_rows($tblswaptire_select4) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row4['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['descripton'];
		}else if(mysql_num_rows($tbltire_select4) > 0){
				 echo $tbltire_row4['descripton'];
			}	?>
	</font>
	...
	<div id="tireforprint-82">
     <font size="-1">
		...
		if(mysql_num_rows($tbltire_select5) == 0 && mysql_num_rows($tblswaptire_select5) == 0 && mysql_num_rows($tblswap_select5) == 0){
			...
			echo $tblswap_row5['description'];
			}else if(mysql_num_rows($tblswaptire_select5) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row5['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['description'];
		}else if(mysql_num_rows($tbltire_select5) > 0){
				 echo $tbltire_row5['description'];
			}	?>
	</font>
    ...
    <font size="-1">
		...
		if(mysql_num_rows($tbltire_select6) == 0 && mysql_num_rows($tblswaptire_select6) == 0 && mysql_num_rows($tblswap_select6) == 0){
			...
			echo $tblswap_row6['description'];
			}else if(mysql_num_rows($tblswaptire_select6) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row6['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['description'];
		}else if(mysql_num_rows($tbltire_select6) > 0){
				 echo $tbltire_row6['description'];
			}	?>
	</font>
  </div>
	...
	<div id="tireforprint-86">
	   <font size="-1">
		...
		if(mysql_num_rows($tbltire_select3) == 0 && mysql_num_rows($tblswaptire_select3) == 0 && mysql_num_rows($tblswap_select3) == 0){
			...
			echo $tblswap_row3['description'];
			}else if(mysql_num_rows($tblswaptire_select3) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row3['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['description'];
		}else if(mysql_num_rows($tbltire_select3) > 0){
				 echo $tbltire_row3['description'];
			}	?>
	</font>
	...
	<div id="tireforprint-138">
     <font size="-1">
        <?php
		if(mysql_num_rows($tbltire_select7) == 0 && mysql_num_rows($tblswaptire_select7) == 0 && mysql_num_rows($tblswap_select7) == 0){
			echo '';
			}
		else if(mysql_num_rows($tblswap_select7) > 0){
			echo $tblswap_row7['tiresize'];
			}else if(mysql_num_rows($tblswaptire_select7) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row7['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['tiresize'];
		}else if(mysql_num_rows($tbltire_select7) > 0){
				 echo $tbltire_row7['tiresize'];
			}	?>
	</font>
	...
	<div id="tireforprint-140">
     <font size="-1">
        <?php
		if(mysql_num_rows($tbltire_select8) == 0 && mysql_num_rows($tblswaptire_select8) == 0 && mysql_num_rows($tblswap_select8) == 0){
			echo '';
			}
		else if(mysql_num_rows($tblswap_select8) > 0){
			echo $tblswap_row8['tiresize'];
			}else if(mysql_num_rows($tblswaptire_select8) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row8['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['tiresize'];
		}else if(mysql_num_rows($tbltire_select8) > 0){
				 echo $tbltire_row8['tiresize'];
			}	?>
	</font>
	...
	<div id="tireforprint-144">
     <font size="-1">
        <?php
		if(mysql_num_rows($tbltire_select9) == 0 && mysql_num_rows($tblswaptire_select9) == 0 && mysql_num_rows($tblswap_select9) == 0){
			echo '';
			}
		else if(mysql_num_rows($tblswap_select9) > 0){
			echo $tblswap_row9['tiresize'];
			}else if(mysql_num_rows($tblswaptire_select9) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row9['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['tiresize'];
		}else if(mysql_num_rows($tbltire_select9) > 0){
				 echo $tbltire_row9['tiresize'];
			}	?>
	</font>
	...
	<div id="tireforprint-146">
     <font size="-1">
        <?php
		if(mysql_num_rows($tbltire_select10) == 0 && mysql_num_rows($tblswaptire_select10) == 0 && mysql_num_rows($tblswap_select10) == 0){
			echo '';
			}
		else if(mysql_num_rows($tblswap_select10) > 0){
			echo $tblswap_row10['tiresize'];
			}else if(mysql_num_rows($tblswaptire_select10) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row10['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['tiresize'];
		}else if(mysql_num_rows($tbltire_select10) > 0){
				 echo $tbltire_row10['tiresize'];
			}	?>
	</font>
	...
	<div id="tireforprint-148">
      <font size="-1">
		...
		if(mysql_num_rows($tbltire_select7) == 0 && mysql_num_rows($tblswaptire_select7) == 0 && mysql_num_rows($tblswap_select7) == 0){
			...
			echo $tblswap_row7['description'];
			}else if(mysql_num_rows($tblswaptire_select7) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row7['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['description'];
		}else if(mysql_num_rows($tbltire_select7) > 0){
				 echo $tbltire_row7['description'];
			}	?>
	</font>
  </div>
    ...
    <font size="-1">
		...
		if(mysql_num_rows($tbltire_select8) == 0 && mysql_num_rows($tblswaptire_select8) == 0 && mysql_num_rows($tblswap_select8) == 0){
			...
			echo $tblswap_row8['description'];
			}else if(mysql_num_rows($tblswaptire_select8) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row8['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['description'];
		}else if(mysql_num_rows($tbltire_select8) > 0){
				 echo $tbltire_row8['description'];
			}	?>
	</font>
	...
	<div id="tireforprint-152">
     <font size="-1">
		...
		if(mysql_num_rows($tbltire_select9) == 0 && mysql_num_rows($tblswaptire_select9) == 0 && mysql_num_rows($tblswap_select9) == 0){
			...
			echo $tblswap_row9['description'];
			}else if(mysql_num_rows($tblswaptire_select9) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row9['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['description'];
		}else if(mysql_num_rows($tbltire_select9) > 0){
				 echo $tbltire_row9['description'];
			}	?>
	</font>
	...
	<div id="tireforprint-155">
     <font size="-1">
		...
		if(mysql_num_rows($tbltire_select10) == 0 && mysql_num_rows($tblswaptire_select10) == 0 && mysql_num_rows($tblswap_select10) == 0){
			...
			echo $tblswap_row10['description'];
			}else if(mysql_num_rows($tblswaptire_select10) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row10['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['description'];
		}else if(mysql_num_rows($tbltire_select10) > 0){
				 echo $tbltire_row10['description'];
			}	?>
	</font>
     ...
     <font size="-1">
       <?php $tbltire_select7 = mysql_query("Select * from tbl_trucktires Where truckplate= '".$_GET['id']."' And tireid='7'") or die(mysql_error());
		...
		if(mysql_num_rows($tbltire_select7) == 0 && mysql_num_rows($tblswaptire_select7) == 0 && mysql_num_rows($tblswap_select7) == 0){
			...
			echo $tblswap_row7['dateadded'];
			}else if(mysql_num_rows($tblswaptire_select7) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row7['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['dateadded'];
		}else if(mysql_num_rows($tbltire_select7) > 0){
				 echo $tbltire_row7['dateadded'];
			}	?>
	</font>
	...
	<div id="tireforprint-160">
     ...
     <?php $tbltire_select8 = mysql_query("Select * from tbl_trucktires Where truckplate= '".$_GET['id']."' And tireid='8'") or die(mysql_error());
		...
		if(mysql_num_rows($tbltire_select8) == 0 && mysql_num_rows($tblswaptire_select8) == 0 && mysql_num_rows($tblswap_select8) == 0){
			...
			echo $tblswap_row8['dateadded'];
			}else if(mysql_num_rows($tblswaptire_select8) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row8['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['dateadded'];
		}else if(mysql_num_rows($tbltire_select8) > 0){
				 echo $tbltire_row8['dateadded'];
			}	?>
	</font>
	  	</div>
	...
	<div id="tireforprint-162">
     ...
     <?php $tbltire_select9 = mysql_query("Select * from tbl_trucktires Where truckplate= '".$_GET['id']."' And tireid='9'") or die(mysql_error());
		...
		if(mysql_num_rows($tbltire_select9) == 0 && mysql_num_rows($tblswaptire_select9) == 0 && mysql_num_rows($tblswap_select9) == 0){
			...
			echo $tblswap_row9['dateadded'];
			}else if(mysql_num_rows($tblswaptire_select9) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row9['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['dateadded'];
		}else if(mysql_num_rows($tbltire_select9) > 0){
				 echo $tbltire_row9['dateadded'];
			}	?>
	</font>
	...
	<div id="tireforprint-164">
     ...
     <?php $tbltire_select10 = mysql_query("Select * from tbl_trucktires Where truckplate= '".$_GET['id']."' And tireid='10'") or die(mysql_error());
		...
		if(mysql_num_rows($tbltire_select10) == 0 && mysql_num_rows($tblswaptire_select10) == 0 && mysql_num_rows($tblswap_select10) == 0){
			...
			echo $tblswap_row10['dateadded'];
			}else if(mysql_num_rows($tblswaptire_select10) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row10['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['dateadded'];
		}else if(mysql_num_rows($tbltire_select10) > 0){
				 echo $tbltire_row10['dateadded'];
			}	?>
	</font>
    ...
    <font size="-1">
		...
		if(mysql_num_rows($tbltire_select7) == 0 && mysql_num_rows($tblswaptire_select7) == 0 && mysql_num_rows($tblswap_select7) == 0){
			...
			echo $tblswap_row7['tirename'];
			}else if(mysql_num_rows($tblswaptire_select7) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row7['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['tirename'];
		}else if(mysql_num_rows($tbltire_select7) > 0){
				 echo $tbltire_row7['tirename'];
			}	?>
            </font>	
	...
	<div id="tireforprint-168">
     <font size="-1">
		...
		if(mysql_num_rows($tbltire_select8) == 0 && mysql_num_rows($tblswaptire_select8) == 0 && mysql_num_rows($tblswap_select8) == 0){
			...
			echo $tblswap_row8['tirename'];
			}else if(mysql_num_rows($tblswaptire_select8) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row8['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['tirename'];
		}else if(mysql_num_rows($tbltire_select8) > 0){
				 echo $tbltire_row8['tirename'];
			}	?>
            </font>	
    ...
    <font size="-1">
		...
		if(mysql_num_rows($tbltire_select9) == 0 && mysql_num_rows($tblswaptire_select9) == 0 && mysql_num_rows($tblswap_select9) == 0){
			...
			echo $tblswap_row9['tirename'];
			}else if(mysql_num_rows($tblswaptire_select9) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row9['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['tirename'];
		}else if(mysql_num_rows($tbltire_select9) > 0){
				 echo $tbltire_row9['tirename'];
			}	?>
            </font>	
    ...
    <font size="-1">
		...
		if(mysql_num_rows($tbltire_select10) == 0 && mysql_num_rows($tblswaptire_select10) == 0 && mysql_num_rows($tblswap_select10) == 0){
			...
			echo $tblswap_row10['tirename'];
			}else if(mysql_num_rows($tblswaptire_select10) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row10['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['tirename'];
		}else if(mysql_num_rows($tbltire_select10) > 0){
				 echo $tbltire_row10['tirename'];
			}	?>
            </font>	
    ...
    <font size="-1">
	   <?php
		if(mysql_num_rows($tbltire_select7) == 0 && mysql_num_rows($tblswaptire_select7) == 0 && mysql_num_rows($tblswap_select7) == 0){
			...
			$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswap_row7['tireid']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
			echo $tire_row1['status'].'('.$tblswap_row7['remarks'].')';
			}else if(mysql_num_rows($tblswaptire_select7) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row7['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['status'].'('.$tblswaptire_row7['remarks'].'to'.$tblswaptire_row7['tireid'].')';
		}else if(mysql_num_rows($tbltire_select7) > 0){
				 echo $tbltire_row7['status'];
			}	?>
	</font>
    ...
    <font size="-1">
	   <?php
		if(mysql_num_rows($tbltire_select8) == 0 && mysql_num_rows($tblswaptire_select8) == 0 && mysql_num_rows($tblswap_select8) == 0){
			...
			$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswap_row8['tireid']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
			echo $tire_row1['status'].'('.$tblswap_row8['remarks'].')';
			}else if(mysql_num_rows($tblswaptire_select8) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row8['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['status'].'('.$tblswaptire_row8['remarks'].'to'.$tblswaptire_row8['tireid'].')';
		}else if(mysql_num_rows($tbltire_select8) > 0){
				 echo $tbltire_row8['status'];
			}	?>
	</font>
    ...
    <font size="-1">
	   <?php
		if(mysql_num_rows($tbltire_select9) == 0 && mysql_num_rows($tblswaptire_select9) == 0 && mysql_num_rows($tblswap_select9) == 0){
			...
			$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswap_row9['tireid']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
			echo $tire_row1['status'].'('.$tblswap_row9['remarks'].')';
			}else if(mysql_num_rows($tblswaptire_select9) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row9['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['status'].'('.$tblswaptire_row9['remarks'].'to'.$tblswaptire_row9['tireid'].')';
		}else if(mysql_num_rows($tbltire_select9) > 0){
				 echo $tbltire_row9['status'];
			}	?>
	</font>
    ...
    <font size="-1">
	   <?php
		if(mysql_num_rows($tbltire_select10) == 0 && mysql_num_rows($tblswaptire_select10) == 0 && mysql_num_rows($tblswap_select10) == 0){
			...
			$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswap_row10['tireid']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
			echo $tire_row1['status'].'('.$tblswap_row10['remarks'].')';
			}else if(mysql_num_rows($tblswaptire_select10) > 0){
				$tire = mysql_query("Select * from tbl_trucktires Where tireid='".$tblswaptire_row10['swapto']."'") or die(mysql_error());
				$tire_row1 = mysql_fetch_array($tire);
						 echo $tire_row1['status'].'('.$tblswaptire_row10['remarks'].'to'.$tblswaptire_row10['tireid'].')';
		}else if(mysql_num_rows($tbltire_select10) > 0){
				 echo $tbltire_row10['status'];
			}	?>
	</font>
