...
<?php } ?>
                    <tr>
                        <td>Owner's Name</td>
                        <td><input type="text" name="owner" value="<?php echo strtoupper($truck_row ['ownersname']); ?>" id="text" onKeyUp="caps(this)"></td>
                    </tr>
                    <tr>
                    ...
                    <td><input type="text" id="text" name="acquisitioncost" value="<?php echo strtoupper($truck_row ['aquisitioncost']); ?>" id="extra7" onKeyPress="return isNumber(event)"></td>
                    <tr>
                        <td>Make: </td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="netbookvalue" value="<?php echo strtoupper($truck_row ['netbookvalue']); ?>" id="text" onKeyPress="return isNumber(event)" ></td>
                    </tr>
                    <tr>
                        <td>Selling Price (Php): </td>

                        <td><input type="text"  name="amount" value="<?php echo strtoupper($truck_row ['amount']); ?>" id="text" onKeyPress="return isNumber(event)"></td>
                    </tr>
                    <tr>
