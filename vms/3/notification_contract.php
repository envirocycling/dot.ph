...
<?php
include('connect.php');
$sen= mysql_query("Select * from tbl_contract Where status LIKE 'approved%' Order by id Asc ")or die (mysql_error());
...
var bottom_center = '<div id="notifications-bottom-right2-tab" style="background-color:#1C1C1C"><div id="notifications-bottom-right2-tab-close" class="close"><span class="iconb" data-icon="&#xe20e;"></span></div><div id="notifications-bottom-right2-tab-avatar"><a href="terminated_contract.php?page=contract"><img src="../icon/truck.png" width="70" height="70" /></a></div><div id="notifications-bottom-right2-tab-right"><div id="notifications-bottom-right2-tab-right-title"><span>Pre-Terminated Contract</span></div><div id="notifications-bottom-right2-tab-right-text"><font size="+1"><?php echo $count."  ";?></font>Approved. <font size="-1">(Click the Image to View.)</font></div></div></div>';
