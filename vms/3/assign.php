...
<select id="supp_drop_down" name="supplier_name" >
...
<!---end of select -->
  ...
  <td><input type="text"  name="amortization" value="<?php echo strtoupper($given_row ['amortization']); ?>" id="text" onKeyPress="return decimal(event)" ></td>
  
  <td>Month/s: </td>
   <td><input type="number" onKeyUp="maxl();" id="e_am"  name="amortization_month"  maxlength="3" value="<?php if(empty($given_row ['amortization_month'])){ echo $diff;}else{ echo $given_row['amortization_month'];} ?>" style="width:50px;" ></td>
  </tr>
  <tr>
  <td>Cash Bond: </td>
   
  <td><input type="text" name="cashbond" id="text"  value="<?php echo strtoupper($given_row ['cashbond']); ?>" id="extra7" onKeyPress="return decimal(event)"></td>
  
  <td>Month/s: </td>
   <td><input onKeyUp="maxl();" type="number" id="e_cm"  name="cashbond_month" value="<?php if(!empty($given_row ['cashbond_month'])){ echo  $given_row ['cashbond_month'];}?>" style="width:50px;"  ></td>
  </tr>
   <tr>
  <td>Proposed Volume: </td>
   
  <td><input type="text"  name="volume" value="<?php echo strtoupper($given_row ['proposedvolume']); ?>" id="text" onKeyPress="return decimal(event)"></td>
   <td>Penalty: </td>
