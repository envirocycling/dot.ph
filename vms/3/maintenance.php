                        ...
                        <table  class="data display datatable">    
                            ...
                            while ($row = mysql_fetch_array($result)) {
                                ...
                                echo '<tr>
											...
											<td class="data">';
                                ?><?php echo '<a href="m_changeoil.php?id=' . $row['id'] . '&page=maintenance"><img src="../icon/change_oil.png" height="35px" title="Change Oil" width="40px" style="cursor:pointer;"></a>'; ?>
                                <?php
                                ...
                                echo '</span></td>
											<td class="data">';
                                ?><?php echo '<a href="m_repair.php?id=' . $row['id'] . '&page=maintenance"><img src="../icon/repair.png" height="35px" title="Repair" width="40px" style="cursor:pointer;"></a>'; ?><?php echo '&nbsp;&nbsp;&nbsp;<span style="text-decoration:underline;font-size:14px;font-weight:bold;">'; ?><?php
                                if ($repair_row['date']) {
                                    echo $repair;
                                }echo '</span></td>
									</tr>';
