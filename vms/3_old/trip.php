...
Month & Year:<input type="month" name="month" required/>
</td>
<td width="15%" align="right"><input value="Proceed" type="submit" name="submit" onclick="return val_trip();"></form></td>
</tr>
</table>
