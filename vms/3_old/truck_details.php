...
//orcr====================================
  ...
  ?>
			...
			?>
            <input type="button" onclick="window.open('view_orcr.php?id=<?php echo $_GET['id'];?>','view_orcr','width=900px,height=500px');" value="View">
			...
			if(!empty($rrow['location'])){
			?>
         <input onclick="window.open('view_deed.php?id=<?php echo $_GET['id'];?>','view_deed','width=900px,height=500px');" type="button" value="View">
            <?php } else if(empty($rrow['location'])){
				echo "NONE";
				} ?>
            </td></tr>
