...
<tr>
 ...
 <option value="10">10</option></td>
  ...
  <option value="HE">HEAVY EQPMNT</option> </td>
 </select>
  </tr>
   <tr>
...
$end_date = $given_row ['enddate'];
$issuance_date = $given_row ['issuancedate'];
?>
<script>
function am(){
	...
	//document.getElementById('e_am2').value=months;
...
<table align="center">
<tr>
				<td align="center" colspan="4"><h3>Given To</h3></td>
				<td></td>
			</tr>
  <tr>
...
<!---end of select -->
  ...
  <td><input type="date"  name="enddate" id="sup_end" value="<?php echo $given_row ['enddate']; ?>" onChange="am();"></td>
  </tr>
  <tr>
  <td>Amortization: </td>
  ...
  <td>Month/s: </td>
   <td><input type="number" onKeyUp="maxl();" id="e_am"  name="amortization_month" value="<?php if(empty($given_row ['amortization_month'])){ echo $diff;}else{ echo $given_row['amortization_month'];} ?>" style="width:50px;" ></td>
  </tr>
  <tr>
  <td>Cash Bond: </td>
  ...
  <td>Month/s: </td>
  <td><input type="number" onKeyUp="maxl();" id="e_cm"  name="cashbond_month" value="<?php if(!empty($given_row ['cashbond_month'])){ echo  $given_row ['cashbond_month'];}?>" style="width:50px;" ></td>
  </tr>
   <tr>
