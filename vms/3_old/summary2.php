...
<?php //======================================================================================?>
 ...
 <center>
  ...
  if(isset( $_POST['filter'])){
	     	$driver = mysql_query("Select * from tbl_trip Where driver ='".$_GET['plate']."' or helper='".$_GET['plate']."' And month LIKE '%".$_POST['filter']."%'   order by day,month,year ASC") or die (mysql_error());
	  }else{
