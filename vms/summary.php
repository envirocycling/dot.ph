...
<td><input value="View Sumary" type="submit" name="submit"></form></td>
</tr>
</table>
...
?>
    ...
    <?php
	$driver = mysql_query("Select * from tbl_trip Where driver ='".$_POST['plate']."' order by truckid,day,month,year ASC") or die (mysql_error());
