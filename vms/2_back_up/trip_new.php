...
?>
Cm: <input type="text"  style="width:100%;font-size:90%;" value="<?php echo round($cm,2);?>" id="cms<?php echo $day;?>" disabled></td>
<td>Lit:<input type="text" style="width:100%;font-size:90%;" value="<?php echo round($con,2);?>" id="lits<?php echo $day;?>"  disabled></td>
