...
.mytd2:hover{
	background-color:#d3e9ff;
		...
		<tr class="data">
			...
			<td align="center"><center><?php echo '<a href="assign.php?id='.$row['id'].'&page=existing">' ?><input type="button" value="Assign"/></a><?php echo '<a href="profile.php?id='.$row['id'].'&page=existing">' ?><input type="button" value="Profile"/></a><?php echo '<a href="edit_truck.php?id='.$row['id'].'&page=existing">' ?><input type="button" value="View/Edit"/></a>	<?php echo '<a href="truck_details.php?id='.$row['id'].'&page=existing">' ?><input type="button" value="Images"/></a> <?php echo '<a href="truck_preowned.php?id='.$row['id'].'" rel="facebox">' ?><input type="button" value="Pre-owned"/></a> </center></td>
		</tr>
