...
<center>
  ...
  <table>
			...
			<tr>
				<td>Owner's Name</td>
				<td><input type="text"  name="ownersname" id="text" onKeyUp="caps(this)" style="width:100%"></td>
			</tr>
         
			<input type="hidden"  name="suppliername" id="text" onKeyUp="caps(this)" style="width:100%">
            ...
            <tr>
				...
				<td><select name="ending" style="width:100%">
            ...
            <tr>	
            <td>Wheels</td>
				<td><select style="width:100%"   name="wheels" id="text"	>
