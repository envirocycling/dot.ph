...
<td><input type="text" onKeyUp="caps(this)" style="width:100%;" name="supplier" value="<?php echo @$trips_row['supplier'];?>" required></td>
<td width="5%"><input style="width:100%" value="<?php echo $trips_row['ton'];?>" type="text" name="ton" required></td>

<td><input type="text" name="ins" id="beg" onKeypress="return isNumber(event)" value="<?php echo @$trips_row['ins'];?>"  style="width:100%;" required></td>
<td><input type="text" name="outs" id="end" onKeypress="return isNumber(event)" style="width:100%;" value="<?php echo @$trips_row['outs'];?>" required> </td> 
<td>
<?php if(!empty($trips_row['ins'])  && !empty($trips_row['supplier'])){?>
<input type="text" name="refill" value="<?php echo $trips_row['refill'];?>" onKeypress="return isNumber(event)" style="width:100%;"><?php }else { ?><input type="hidden" name="refill" value="0" ><?php echo "N/A"; }?></td>  
<td>
...
<tr>
<td>
<input type="button" value="UP" onclick="show()"></td></tr>
<?php
	$day++;
	}
?>
