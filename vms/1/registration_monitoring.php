...
<table width="60%" align="center"><tr><td>
 <table width="60%"  border="1px" align="center" class="CSSTableGenerator">    
   ...
   if(isset($_POST['filter'])){
  			if($_POST['month'] == 't'){
			$result= mysql_query("Select * from tbl_truck_report ORDER BY ending ASC ") or die (mysql_error()); }else{
			$result= mysql_query("Select * from tbl_truck_report Where ending='".$_POST['month']."' ORDER BY ending ASC") or die (mysql_error()); }
