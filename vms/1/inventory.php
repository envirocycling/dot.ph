...
Select Tool:<select name="tools" id="combobox">
		<?php 
		$tool = mysql_query("Select * from tbl_tool Order by name Asc") or die (mysql_error());
...
<!---end of select -->
  ...
  <br /><br /><form action="" target="_self" method="post">
    ...
    <tr><td> <?php if(isset($_POST['search'])){?>
  ...
  <input type="submit" name="search" value="Search"><input type="text" name="text" placeholder="Type Here" onKeyUp="caps(this)"><?php }?></td></tr>
    <tr><td>
