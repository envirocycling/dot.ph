...
<td>
 ...
 <form action="re_addtool.php?p=<?php echo $_GET['p'];?>" method="post" name="form">
...
$remaining = $qty - $issued;
  ?>
<td>Quantity: <input style="width:30%" min="1" value="1" max="<?php echo $remaining;?>" type="number" name="qty" id="extra7" onKeyPress="return isNumber(event)" required></td>
<td>Available:
<?php
$qtools = mysql_query("Select * from tbl_addinventorytool Where name='".$_POST['tool']."'") or die (mysql_error());
$row = mysql_fetch_array($qtools);
...
<input type="submit" name="add" value="Add Tool"> </td>
</form>
