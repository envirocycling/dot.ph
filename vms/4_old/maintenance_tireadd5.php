...
<?php
include('connect.php');
$select = mysql_query("Select * from tbl_changeswaps Where truckid='".$_GET['p']."' And tireid='5' And remarks='swap' Order by id Desc LIMIT 1") or die (mysql_error());
$row = mysql_fetch_array($select);

$select_swapto = mysql_query("Select * from tbl_changeswaps Where  truckid='".$_GET['p']."' And swapto='5' And remarks='swap' Order by id Desc LIMIT 1") or die (mysql_error());
...
$select_tire= mysql_query("Select * from tbl_trucktires Where truckplate='".@$_GET['p']."' And tireid='5'") or die (mysql_error());}
...
$select_historyc= mysql_query("Select * from tbl_changeswaps Where remarks='change' And tireid='5' order by id Desc LIMIT 1") or die(mysql_error());
$row_historyc = mysql_fetch_array($select_historyc);
$num = mysql_num_rows($select_historyc);


$selects = mysql_query("Select * from tbl_changeswaps Where truckid='".$_GET['p']."' And tireid='5'  And remarks='swap' Order by id Desc LIMIT 1") or die (mysql_error());
...
<?php
$selects = mysql_query("Select * from tbl_changeswaps Where truckid='".$_GET['p']."' And tireid='5' Order by id Desc LIMIT 1") or die (mysql_error());
$rows =mysql_fetch_array($selects); 
?>
...
<input style="width:87%" type="text"  value="5" disabled>
<input  type="hidden" name="tireid" value="5" >
<?php } ?>
</td></tr>
<tr>
<td>Brand:</td>
