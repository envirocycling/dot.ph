...
<tr>
<td>Quantity:</td>
<td><input type="number" name="qty" style="width:30%" onKeyPress="return isNumber(event)" min="1" ></td>
</tr>
<tr>
...
<?php if($_SESSION['owner'] == $rplate['branch'] || $_SESSION['owner'] == 'PAMPANGA'){?>
<td width="10%" align="center" colspan="2">Action</td><?php }?>
</tr>
...
if($_SESSION['owner'] == $rplate['branch'] || $_SESSION['owner'] == 'PAMPANGA'){
?>
	   <td><a rel="facebox" href="update_tools.php?id=<?php echo $vrow['ti'];?>"><input type="button" value="Update"></a></td>
