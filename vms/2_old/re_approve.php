...
//$givendelete= mysql_query("Delete from tbl_givento Where truckid='".$_POST['id']."'") or die(mysql_error());


$delete = mysql_query("Delete from tbl_reassign Where id='".$_GET['id']."'") or die(mysql_error());
$delete2 = mysql_query("Delete from tbl_chat Where tid='".$_POST['id']."'") or die(mysql_error());
	...
	$insert = mysql_query("Insert into tbl_reassignmenthistory (truckplate,branch,issuancedate,enddate,prepared,remarks,status,date_approved)
Values ('".$_POST['id']."','".$_POST['branch']."','".$_POST['issuancedate']."','$date','".$_POST['preparedby']."','".$_POST['remarks']."','For Repair','$date')") or die (mysql_error());
