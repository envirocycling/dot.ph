...
<form action="trip_bef.php" method="post">
<!---beginning of select -->
...
<?php
$query=mysql_query("Select * from tbl_truck_report Where branch='".$_SESSION['owner']."'") or die (mysql_error());
...
<option value="<?php echo $dates.'-'.$date;?>"><?php echo $date;?></option>
...
<td width="15%" align="right"><input value="Proceed" type="submit" name="submit"></form></td>
</tr>
</table>
