...
$selected = mysql_query("Select * from tbl_reassign Where  noti_rec='0' and suppliername='".$_SESSION['owner']."' Order by id Asc")or die (mysql_error());
...
/*
$given_branch1 = mysql_query("Select * from tbl_givento Where name='".$branches_row['branch_name']."' And (suppliername = '1449' or suppliername = '1450' or suppliername = '1452' or suppliername = '1453'  or suppliername = '1454' or suppliername = '1455' or suppliername = '1456' or suppliername = '1458' or suppliername = '14025' or suppliername = '14066' or suppliername = '14317')") or die(mysql_error());
while($row_branch1 = mysql_fetch_array($given_branch1)){
...
<table  style="position:absolute; left:400px;"id="sum_table2" hidden="">
	<tr>
		<td>
...
.mytd2:hover{
	background-color:#d3e9ff;
		...
		<tr class="<?php echo $css;?>">
			...
			<td align="center"><font size="-2"><?php echo strtoupper($row['branch']); ?></font></td>
			...
			<td align="center"><center><?php echo '<a href="assign.php?id='.$row['id'].'">' ?><input type="button" value="Assign"/></a><?php echo '<a href="profile.php?id='.$row['id'].'">' ?><input type="button" value="Profile"/></a><?php echo '<a href="edit_truck.php?id='.$row['id'].'">' ?><input type="button" value="View/Edit"/></a>	<?php echo '<a href="truck_details.php?id='.$row['id'].'">' ?><input type="button" value="Images"/></a> </center></td>
		</tr>
