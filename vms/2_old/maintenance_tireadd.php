...
$val = 'disabled';
echo '<input type="hidden" id="vals" value="true">';
}else{
echo '<input type="hidden" id="vals" value="false">';
$val='';
}
...
$select_history = mysql_query("SELECT * from tbl_changeswaps WHERE tireid='$tire_id' and truckid='$truck_id' and remarks='change' ") or die (mysql_error());
