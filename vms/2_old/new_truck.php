...
<center>
  ...
  <table>
            ...
            <tr>
				<td>Make</td>
				<td><input type="text" style="width:100%"  name="make" id="text" onKeyUp="caps(this)" onKeyPress="return isNumbers(event)" required></td>
			</tr>
			<tr>
				<td>Series</td>
				<td><input type="text" style="width:100%"  name="series" id="text" onKeyUp="caps(this)" required></td>
			</tr>
			<tr>	
            <td>Body  Type</td>
				<td><input type="text" style="width:100%"  name="bodytype" id="text" onKeyUp="caps(this)"  required></td>
			</tr>
            <tr>	
            <td>Wheels</td>
            ...
            <td>Class</td>
				<td>
					<select style="width:100%"   name="class" id="text" required>
				<option value="" selected="selected" disabled="disabled">Please Select</option>
			...
			<tr>
				...
				<td><input type="text"  style="width:100%" name="aquisitioncost" id="text" onKeyUp="caps(this)" onKeyPress="return isNumber(event)" required></td>
			</tr>
			<tr>
            
				<td>Net Book Value (Php)</td>
				<td><input type="text"  style="width:100%" name="netbookvalue" id="extra7" onKeyPress="return isNumber(event)" required></td>
			</tr>
			<tr>
				<td>Selling Price(Php)</td>
				<td><input type="text" style="width:100%"  name="amount" id="extra7" onKeyPress="return isNumber(event)" required></td>
			</tr>
              <tr>
