...
<script>
 function cons(){
	var valid = true;
	if(document.getElementById('out1').value == '' && document.getElementById('out2').value == ''){
...
<table align="left" width="550px" >
    ...
    <tr>
     <td>Diesel Conversion:</td>
    <td>
    <input type="text" maxlength="3" id="out1" min="0" name="out1"  onKeypress="return isNumber(event)" style="width:15%" required><font size="+3">.</font><input type="text" maxlength="2" id="out2" name="out2"  pattern=".{2,}"  title="2 characters minimum" placeholder='decimal'  onKeypress="return isNumber(event)" style="width:15%"  required></td>
    </tr>
    <tr>
    <td>
    </td>
