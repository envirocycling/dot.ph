...
<div id="<?php echo 'costs_'.$day;?>" class="editbox"><input type="text" name="cost" id="<?php echo 'cost_'.$day;?>"  value="<?php echo $trips_row['cost']?>" style="width:100%" />
</div>
...
<div id="<?php echo 'drivers_'.$day;?>" class="editbox"><input value="<?php echo @$trips_row['driver'];?>" id="<?php echo 'driver_'.$day;?>" type="text" onKeyUp="caps(this)" name="driver" style="width:100%" />
</div>
...
<div id="<?php echo 'helpers_'.$day;?>" class="editbox"><input type="text" id="<?php echo 'helper_'.$day;?>"  onKeyUp="caps(this)" value="<?php echo @$trips_row['helper'];?>" name="helper" style="width:100%" />
</div>
...
<div id="<?php echo 'remarkss_'.$day;?>" class="editbox"><textarea name="remarks" id="<?php echo 'remarks_'.$day;?>" onKeyUp="caps(this)" rows="3" style="width:100%" /><?php echo @$trips_row['remarks'];?></textarea>
</div>
...
<div id="<?php echo 'violations_'.$day;?>" class="editbox"><textarea name="remarks" id="<?php echo 'violation_'.$day;?>" onKeyUp="caps(this)" rows="3" style="width:100%" /><?php echo @$trips_row['violation'];?></textarea>
</div>
