...
<?php
include('connect.php');
$sen= mysql_query("Select * from tbl_reassign Where name='".$_SESSION['owner']."' ")or die (mysql_error());
...
var bottom_center = '<div id="notifications-bottom-right-tab" style="background-color:#1C1C1C"><div id="notifications-bottom-right-tab-close" class="close"><span class="iconb" data-icon="&#xe20e;"></span></div><div id="notifications-bottom-right-tab-avatar"><a href="truck_reassign.php"><img src="../image/truck.png" width="70" height="70" /></a></div><div id="notifications-bottom-right-tab-right"><div id="notifications-bottom-right-tab-right-title"><span>Truck Reassignment</span></div><div id="notifications-bottom-right-tab-right-text"><font size="+1"><?php echo $count."  ";?></font>Pending Reassign Truck. <font size="-1">(Click the Image to View.)</font></div></div></div>';
