...
<font size="-1">
	...
	<div id="tireforprint-48">
     <font size="-1"><?php
		echo $tbltire_row11['status'];	?></font>
    ...
    <font size="-1">
        <?php echo $tbltire_row5['tiresize'];?>
	</font>
    ...
    <font size="-1">
        <?php echo $tbltire_row6['description'];?>
	</font>
  </div>
    ...
    <font size="-1">
     <?php echo $tbltire_row5['dateadded'];?>
	</font>
	...
	<div id="tireforprint-94">
     <font size="-1">
     <?php  echo $tbltire_row6['dateadded'];?>
	</font>
	...
	<div id="tireforprint-101">
     <font size="-1">
        <?php echo $tbltire_row5['tirename'];?>
      </font>	
    ...
    <font size="-1">
        <?php echo $tbltire_row6['tirename'];?>
      </font>	
	...
	<div id="tireforprint-119">
     <font size="-1">
	   <?php  echo $tbltire_row6['status'];?>
	</font>
	 
	</div>
	<div id="tireforprint-120">
    <font size="-1">
	   <?php echo $tbltire_row5['status'];?>
	</font>
	...
	<div id="tireforprint-138">
     <font size="-1">
        <?php echo $tbltire_row7['tiresize'];?>
	</font>
	...
	<div id="tireforprint-140">
     <font size="-1">
        <?php echo $tbltire_row8['tiresize'];?>
	</font>
	...
	<div id="tireforprint-144">
     <font size="-1">
        <?php echo $tbltire_row9['tiresize'];?>
	</font>
	...
	<div id="tireforprint-146">
     <font size="-1">
        <?php  echo $tbltire_row10['tiresize']; ?>
	</font>
    ...
    <font size="-1">
        <?php echo $tbltire_row8['description']; ?>
	</font>
	...
	<div id="tireforprint-152">
     <font size="-1">
        <?php  echo $tbltire_row9['description']; 	?>
	</font>	</div>
	...
	<div id="tireforprint-155">
     <font size="-1">
        <?php echo $tbltire_row10['description']; ?>
	</font>
	...
	<div id="tireforprint-157">
     <font size="-1">
       <?php   echo $tbltire_row7['dateadded']; ?>
	</font>
	...
	<div id="tireforprint-160">
     <font size="-1">
     <?php   echo $tbltire_row8['dateadded']; 	?>
	</font>
  </div>
	...
	<div id="tireforprint-162">
     <font size="-1">
     <?php  echo $tbltire_row9['dateadded']; 	?>
	</font>
	...
	<div id="tireforprint-164">
     <font size="-1">
     <?php   echo $tbltire_row10['dateadded']; ?>
	</font>
