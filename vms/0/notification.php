...
var bottom_center = '<div id="notifications-bottom-right-tab" style="background-color:#1C1C1C"><div id="notifications-bottom-right-tab-close" class="close"><span class="iconb" data-icon="&#xe20e;"></span></div><div id="notifications-bottom-right-tab-avatar"><a href="truck_reassign.php?page=reassign"><img src="../icon/truck.png" width="70" height="70" /></a></div><div id="notifications-bottom-right-tab-right"><div id="notifications-bottom-right-tab-right-title"><span>Truck Reassignment</span></div><div id="notifications-bottom-right-tab-right-text"><font size="+1"><?php echo $count."  ";?></font>Pending To Approve. <font size="-1">(Click the Image to View.)</font></div></div></div>';
