...
<?php
include('connect.php');
$receciveing= mysql_query("Select * from tbl_contract Where status LIKE '%pending%' and gm_noti='0' Order by id Asc")or die (mysql_error());
...
var bottom_center = '<div id="notifications-bottom-right1-tab" style="background-color:#1C1C1C"><div id="notifications-bottom-right1-tab-close" class="close"><span class="iconb" data-icon="&#xe20e;"></span></div><div id="notifications-bottom-right1-tab-avatar"><a href="terminated_contract.php?page=contract"><img src="../icon/truck.png" width="70" height="70" /></a></div><div id="notifications-bottom-right1-tab-right"><div id="notifications-bottom-right1-tab-right-title"><span>Pre-Terminated Contract</span></div><div id="notifications-bottom-right1-tab-right-text"><font size="+1"><?php echo $count."  ";?></font>Pending to Approved. <font size="-1">(Click the Image to View.)</font></div></div></div>';
