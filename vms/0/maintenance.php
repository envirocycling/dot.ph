...
<?php date_default_timezone_set("Asia/Singapore"); include('layout/header.php'); include('connect.php');?>
						...
						<?php
							while($row = mysql_fetch_array($result)){
								...
								echo '<tr>
											...
											<td class="data">';?><?php echo '<a href="m_changeoil.php?id='.$row['id'].'&page=maintenance"><img src="../icon/change_oil.png" height="35px" title="Change Oil" width="40px" style="cursor:pointer;"></a>';?><?php if(!empty($row['oil'])){ echo '<b>Prev:</b><span style="text-decoration:underline;font-size:14px;"><b>'.$date.'</b></span>';}if(!empty($row['oil'])){ echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Next:</b><span style="text-decoration:underline;font-size:14px;font-weight:bold;">'.$next;}echo '</span></td>
											<td class="data">';?><?php echo '<a href="m_repair.php?id='.$row['id'].'&page=maintenance"><img src="../icon/repair.png" height="35px" title="Repair" width="40px" style="cursor:pointer;"></a>';?><?php echo '&nbsp;&nbsp;&nbsp;<span style="text-decoration:underline;font-size:14px;font-weight:bold;">';?><?php if($repair_row['date']){echo $repair;}echo '</span></td>
									</tr>';
							}
$date = date('Y-m-d');							
$select_date = mysql_query("Select * from tbl_truck_report Where (oil_next <= '$date' or oil_next='') and status=''") or die (mysql_error());
?>
					</table>	
					</td>
					</tr>
