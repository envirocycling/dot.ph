    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                $('[name=btnAction]').click(function () {
                    var _con = confirm('Do you want to proceed?');
                    if(_con === true){
                        var _this = this.value;
                        var _id = "<?php echo $_GET['id']; ?>";
                        $.ajax({
                            url: 'truck_request_action.php?action=' + _this + '&id=' + _id,
                            async: false
                        }).done(function(){
                            alert("Successful.");
                                                                                                                                                                            ...
                                                                                                                                                                            <td><h4>Volume Summary<h4></td>
                                                                                                                                                                                        <td><span name="spnFirst"><h5><?php echo $f[0]; ?><h5></span></td>
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        <td>Approved by: <?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    } else if ($row_truckrequest['status'] == 'Pending to GM') {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        echo '<br/><button name="btnAction" value="approved">Approve</button>&nbsp;&nbsp;|&nbsp;&nbsp;<button name="btnAction" value="disapproved">Disapprove</button>';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        echo '<br/>';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    echo '<br/>';
