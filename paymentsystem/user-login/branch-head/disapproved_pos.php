        ...
        <table class="data display datatable" id="example">
            <article>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $query = "SELECT * FROM payment WHERE status='disapproved' and branch_code like '%" . $_SESSION['branch'] . "%' and bh_disapproved_noti='0'";
                }
...
//                    echo "<td>" . $row['reference_number'] . "</td>";
                    ...
                    if ($row['disapproved_time'] != '') {
                        echo " " . date("h:i a", strtotime($row['disapproved_time']));
                    }
                    echo "</td>";
                    if ($row['status'] == '') {
                        echo "<td>pending</td>";
                ...
                mysql_query("UPDATE payment SET bh_disapproved_noti='1' WHERE branch_code like '%" . $_SESSION['branch'] . "%'");
                ?>
        </table>
