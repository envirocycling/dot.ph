...
if (isset ($_GET['deactivate_id'])) {
    mysql_query("UPDATE users SET status='deactivated' WHERE user_id='".$_GET['deactivate_id']."'");
}
if (isset ($_GET['activate_id'])) {
    mysql_query("UPDATE users SET status='' WHERE user_id='".$_GET['activate_id']."'");
}
            ...
            <td>
                <table class="data display datatable" id="example">
                    <article>
                        ...
                        $sql = mysql_query("SELECT * FROM users WHERE usertype='5' and branch='".$_SESSION['branch']."'");
