...
if (isset($_GET['disapprove_id'])) {
    mysql_query("UPDATE payment SET status='disapproved',disapproved_date='" . date("Y/m/d") . "', disapproved_time='" . date("h:i:s a") . "' WHERE payment_id='" . $_GET['disapprove_id'] . "'");
    echo "<script>
...
if (isset($_GET['approve_id'])) {
    mysql_query("UPDATE payment SET status='approved',approved_date='" . date("Y/m/d") . "', approved_time='" . date("h:i:s a") . "' WHERE payment_id='" . $_GET['approve_id'] . "'");
    echo "<script>
...
if (isset($_GET['cancel_id'])) {
    $selects = mysql_query("SELECT * from payment WHERE payment_id='" . $_GET['cancel_id'] . " and  status='generated'") or die(mysql_error());
