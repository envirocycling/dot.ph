            ...
            <article>
                ...
                if (isset($_POST['submit'])) {
                    if ($_SESSION['position'] == 'Reliever') {
                        $query = "SELECT * FROM payment WHERE status='' and branch_code like '%" . $_SESSION['branch'] . "%' and signatory like '%" . $_SESSION['initial'] . "%' and date>='" . $_POST['from'] . "' and date<='" . $_POST['to'] . "'";
                    } else {
                        $query = "SELECT * FROM payment WHERE status='' and branch_code like '%" . $_SESSION['branch'] . "%' and date>='" . $_POST['from'] . "' and date<='" . $_POST['to'] . "'";
                    }
                } else {
                    if ($_SESSION['position'] == 'Reliever') {
                        $query = "SELECT * FROM payment WHERE status='' and branch_code like '%" . $_SESSION['branch'] . "%' and signatory like '%" . $_SESSION['initial'] . "%'";
                    } else {
