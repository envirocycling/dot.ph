        ...
        <table class="data display datatable" id="example">
            <article>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $query = "SELECT * FROM payment WHERE status='generated' and branch_code like '%" . $_SESSION['branch'] . "%' and bh_approved_noti='0'";
                }
...
//                    echo "<td>" . $row['branch_code'] . "</td>";
                ...
                mysql_query("UPDATE payment SET bh_approved_noti='1' WHERE status='generated' and branch_code like '%" . $_SESSION['branch'] . "%'");
                ?>
        </table>
