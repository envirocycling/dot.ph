            ...
            <div class="c1">
                <div class="controls">
                    <nav class="links">
                        <ul>
                            <li>
                                <a href="index_new.php?branch=Pampanga" class="">Request for POs <span class="num">
                                        <?php
                            ...
                            <li>
                                <a href="generate_pos.php" class="">Generate Batch POs <span class="num">
                                        <?php
                                        include('configPhp.php');
                                        $query = "SELECT count(payment_id) FROM payment WHERE status='approved' and printed='1'";
                                        $result = mysql_query($query);
                                        while ($row = mysql_fetch_array($result)) {
                                            echo $row['count(payment_id)'];
                                        }
