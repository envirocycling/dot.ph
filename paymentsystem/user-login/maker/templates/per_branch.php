                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="index_new.php?branch=Urdaneta" class="">Urdaneta<span class="num">
                                    ...
                                    <li>
                                        <a href="index_new.php?branch=San%20Pedro" class="">
                                            San Pedro
                                            <span class="num">
                                                <?php
                                                include('configPhp.php');
                                                $query = "SELECT count(payment_id) FROM payment WHERE status='approved' and branch_code like '%San Pedro%'";
                                                $result = mysql_query($query);
                                                while ($row = mysql_fetch_array($result)) {
                                                    echo $row['count(payment_id)'];
                                                }
                                    ...
                                    <li>
                                        <a href="index_new.php?branch=Silang" class="">
                                            Silang
                                            <span class="num">
                                                <?php
                                                include('configPhp.php');
                                                $query = "SELECT count(payment_id) FROM payment WHERE status='approved' and branch_code like '%Silang%'";
                                                $result = mysql_query($query);
                                                while ($row = mysql_fetch_array($result)) {
                                                    echo $row['count(payment_id)'];
                                                }
                                    ...
                                    <li>
                                        <a href="index_new.php?branch=San%20Fernando" class="">
                                            San Fernando
                                            <span class="num">
                                                <?php
                                                include('configPhp.php');
                                                $query = "SELECT count(payment_id) FROM payment WHERE status='approved' and branch_code like '%San Fernando%'";
                                                $result = mysql_query($query);
                                                while ($row = mysql_fetch_array($result)) {
                                                    echo $row['count(payment_id)'];
                                                }
