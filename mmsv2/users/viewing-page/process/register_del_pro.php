...
if(mysql_query("INSERT INTO delinquency (date_submitted, company_id, emp_num, branch_id, violation, date_committed, description, status, submitted_by, submitted_date, type)
    ...
    $message = "Good day Ma'am/Sir \r\n Please click the link below to see the full details of the report \r\n" . "http://mmsv2.efi.net.ph/view_emp_delinquency.php?d_id=" . $d_id . "\r\n\n Thank you.. \r\n\n Note: <b>This is a system generated email, do not reply to this email</b>. Use Google Chrome or Mozilla Firefox to view it properly.\r\n\n";
    $from = 'sample';
    $headers = "From: envirocyclingfiberincorporated@efi.net.ph" . "\r\n". "CC: mr.caridaoanp@gmail.com";
