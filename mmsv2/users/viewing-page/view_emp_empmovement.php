...
<?php
    ...
    if(isset($_POST['transferred'])){
        if(mysql_query("UPDATE manpower_movement SET status='transferred', date_transferred='".date('Y-m-d')."'  WHERE mm_id = '".$_GET['mm_id']."'") or die(mysql_error())){
    ...
    if($type == 'transfer'){
        ...
        $sql_bh_user = mysql_query("SELECT * from users WHERE user_type = '3' and branch_id LIKE '%(".$type_data[1].")%'") or die(mysql_error());
    ...
    <center>
                        ...
                        <table width="1100px">
                            ...
                            <tr>
                                ...
                                <td><center>
                        <?php
                            if($row_mm['status'] == 'approved by gm' || $row_mm['status'] == 'transferred'){
                        ...
                        ?></center></td>
                            ...
                            <tr>
                                <td colspan="3"></td>
                                <td></td>
                                <td><center><font size="-1">General Manager</font></center></td>
                            </tr>
                            <?php
