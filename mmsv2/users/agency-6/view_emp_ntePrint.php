...
if ($row_nte['supervisor_num'] > 0) {
    ...
    $supSig = '<span class="sig">Signed</span><br/>';
}
...
<center>
    <table>
        ...
        <tr>
            <td colspan="2"><?php echo $supSig . '<span class="txt3">' . $employee_fullname_sub . '</span><br><span class="txt4">' . $rowPos . '</span><br /><br /><br />'; ?></td>
            <td></td>
        </tr>
        <tr>
