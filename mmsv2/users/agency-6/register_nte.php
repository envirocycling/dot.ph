    ...
    <body>
                            ...
                            <table width="85%">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        $sql_employee = mysql_query("SELECT * from employees WHERE company_id='" . $_SESSION['company_id'] . "' ORDER BY lastname Asc") or die(mysql_error());
                                ...
                                <tr>
                                    <td colspan="2"><?php echo '<span class="txt3">' . $fullname . '</span><br><span class="txt4">' . $row_emp['description'] . '</span><br /><br /><br /><br />'; ?></td>
                                    <td></td>
                                </tr>
                                <tr>
        ...
        <script>
                                        $(document).ready(function () {
                                            ...
                                            var _thisGet = "<?php echo $_GET['emp_num']?>";
                                            var _thisId = "<?php echo $_GET['d_id'];?>";
                                            $.ajax({
                                                url: 'process/register_nteData.php?emp_num=' + _thisGet,
                                                async: false
                                            }).done(function (e) {
                                                var eSplit = e.split('~');
                                                $('#emp_num option[value="'+_thisGet +'"]').prop('selected', true);
                                                ...
                                                $('[name=delinquency] option[value="'+_thisId +'"]').prop('selected', true);
