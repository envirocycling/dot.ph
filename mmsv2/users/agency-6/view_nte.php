                ...
                <div class="container">
                    ...
                    <div class="title">
                        ...
                        if (isset($_POST['filter'])) {
                            $sql_del = mysql_query("SELECT * from nte WHERE date_submitted >= '" . $_POST['from'] . "' and date_submitted <= '" . $_POST['to'] . "' and company_id='".$_SESSION['company_id']."'") or die(mysql_error());
                            $from = $_POST['from'];
                            $to = $_POST['to'];
                        } else {
                            $sql_del = mysql_query("SELECT * from nte WHERE date_submitted LIKE '" . date('Y-m') . "%' and company_id='".$_SESSION['company_id']."'") or die(mysql_error());
                            $from = date('Y/m');
                            $from = $from . '/01';
                            $to = date('Y/m/t');
                        }
