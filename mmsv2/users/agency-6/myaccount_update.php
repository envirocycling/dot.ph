                ...
                <div class="container">
                    ...
                    <div class="main">
                        ...
                        if(isset($_POST['update'])){
                            ...
                            $ses_uname = strtolower($_SESSION['username-6']);
                            ...
                            @$target_dir = "../../images/agency/";
                            $new_filename = $row_user['agency_id'].'.png';
                                ...
                                <tr>
                                    <td colspan="2"><center>
                                        ...
                                        if (file_exists($image_path)) {
                                            ?>
                                            <img src="../../images/agency/<?php echo $row_user['agency_id']; ?>.png" style="width:300px;">
                                            <?php } else {
                                            ?>
                                ...
                                <tr>
                                    <td align="right">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" style="height:35px;" placeholder="Required" value="<?php echo $_SESSION['username-6'];?>" name="username" autocomplete="off"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
