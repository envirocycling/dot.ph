...
<?php
    ...
    if(isset($_POST['received'])) {
        ...
        if(mysql_query("UPDATE manpower_movement SET status='received', date_received='$date'  WHERE mm_id = '".$_GET['mm_id']."'") or die(mysql_error())) {
    ...
    <center>
                        ...
                        <table width="1100px">
                            ...
                            <tr>
                                ...
                                <td><center>
                        <?php
                            if($row_mm['status'] == 'approved by gm' || $row_mm['status'] == 'transferred' || $row_mm['status'] == 'received'){
                        ...
                        ?></center></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                        // New - 2019/05/14 - Jays
                                        if($row_mm['status']== 'pending') {

                                        }else if($row_mm['status'] == 'received') {
                                            echo '<img src="../../images/signature/'.$_bh_id.'.png" width="90">';
                                        }else if($row_mm['status'] == 'transferred') {
                                            echo '<form method="post" onsubmit="return confirm(\'Do you want to proceed? You cannot undo this process.\');"><input type="submit" class="btn btn-success" value="Received" name="received"></form>';
                                        }
                                    ?>
                                    </center>
                                </td>
