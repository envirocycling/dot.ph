                ...
                <div class="container">
                    ...
                    <div class="title">
                        ...
                        if (isset($_POST['filter'])) {
                            ...
                            $not = $_GET['noti'];
                            if($not > 0) {
                                $sql_del = mysql_query("SELECT * from delinquency WHERE (status LIKE 'pending to supervisor' or implementation_status LIKE 'pending to supervisor') ") or die(mysql_error());
                            } else {
