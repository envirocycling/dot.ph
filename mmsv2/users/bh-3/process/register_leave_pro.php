...
if (mysql_query("INSERT INTO leaves (emp_num, date_submitted, branch_id, position_id, date_affected1, date_affected2, no_days, leave_type, cs_date1, cs_date2, os_date, specify, reason, reliever1_id, reliever2_id, supervisor_id, manager_id, status, reliever1_status, reliever2_status, supervisor_status, manager_status, validated)
        VALUES ('$emp_num', '$date_submitted', '$branch', '$position', '$date_affected1', '$date_affected2', '$no_days', '$leave_type', '$cs_date1', '$cs_date2', '$os_date', '$specify', '$reason', '$reliever1', '$reliever2', '$supervisor', '$manager', '$status', '$r1_status', '$r2_status', 'pending', 'pending','$validate')") or die(mysql_error())) {
