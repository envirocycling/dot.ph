...
//    }
    ...
    mysqli_query($con, "UPDATE delinquency SET nte='" . $row_max['nte_id'] . "', action='created Notice to Explain', action_date='$aDate', status='action taken' WHERE d_id='$delinquency'");
    mysqli_close($con);
    echo '<script>
