...
if($pageWasRefreshed ) {
    ...
    }else if(@$_GET['http'] == '201'){
    $actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
    $actual_link = str_replace("&http=201","",$actual_link);
    echo '<script>
            window.top.location.href="'.$actual_link.'";
    </script>';
    ...
    }else if(@$_GET['http'] == '401'){
    $actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
    $actual_link = str_replace("&http=401","",$actual_link);
    echo '<script>
            window.top.location.href="'.$actual_link.'";
    </script>';
    }
...
if(@$_GET['http'] == '201'){include 'alert_success.php';}
if(@$_GET['http'] == '400'){include 'alert_exist.php';}
if(@$_GET['http'] == '401'){include 'alert_security.php';}
?>
<head>
