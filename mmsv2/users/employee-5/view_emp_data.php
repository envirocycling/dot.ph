...
echo '</td>';
if (@$emp_deactivated == 1) {
    echo '<td><b>Date Separated: <i>' . date('F d, Y', strtotime($row_emp_data['date_separated'])); if($row_company['type'] == '1'){echo '<br><a href="../../forms/clearance.php?emp_num='.$row_emp_data['emp_num'].'" target="_blank">View clearance form</a></i></b>';} echo'</td>
