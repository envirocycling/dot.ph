                ...
                <div class="container">
                    ...
                    <div class="main">
                        ...
                        if(isset($_POST['update'])){
                            ...
                            $ses_uname = strtolower($_SESSION['username-1']);
                                ...
                                if($_SESSION['password'] == $current_password){
                                    if($username == $ses_uname){
                                        if(mysql_query("UPDATE users SET password = '$password' WHERE username='$username'") or die(mysql_error())){
                                           ...
                                           echo '<script>
                                                    location.replace("myaccount_update.php?active=myaccount&http=200");
                                               </script>'; 
                                        }else{
                                            echo '<script>
                                ...
                                <tr>
                                    <td align="right">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" style="height:35px;" placeholder="Required" value="<?php echo $_SESSION['username-1'];?>" name="username" autocomplete="off"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
