    ...
    <ul>
        ...
        <li class='<?php echo @$register;?>'><a><span>Register</span></a>
            <ul>
                ...
                <li class="pages"><a href="register_user.php?active=register">Users</a></li>
                <li class="pages"><a href="register_signature.php?active=register">E-Signature</a></li>
                <li class="pages"><a href="register_email.php?active=register">Email Address</a></li>
            </ul>  
        </li>
       <li class="<?php echo $view;?>"><a><span>View</span></a>
            <ul>
                <li class="pages"><a href="view_user.php?status=active&active=view">User</a></li>
                <li class="pages"><a href="view_email.php?status=active&active=view">Email Address</a></li>
                <li><a>Employee</a>
                    <ul>
