                            ...
                            <table width='100%'>
                                ...
                                <tr id="datas">
                                    <td colspan="4"><center><br><br>Company Name: <input type="text" id="company_name" required> Description: <input type="text" id="description" required>
                                        ...
                                        <br>Address: <input type="text" id="address" style="width:300px;">&nbsp;&nbsp;Gov. #: <input type="text" id="gov_no" style="width:300px;">
	...
	<script type="text/javascript">
        ...
        $('button').click(function(){
                ...
                if(action == 'cancel'){
                    ...
                    if(company_name != '' && description != '' && address != '' && gov_no != '' && (type == '1' || type == '0')){
                        var dataX = 'company_name=' + company_name + '&description=' + description + '&type=' + type + '&address=' + address + '&gov_no=' + gov_no + '&action=update';
                            $.ajax({
                                url: 'process/maintenance_edit.php',
                                type: 'POST',
                                data: dataX,
