    ...
    <body>
                    ...
                    <div class="main">
                        <br><br><center>
                            ...
                            <table width="95%">
                                ...
                                <tr>
                                    <td align="right"><br><br><br><input type="button" onclick="tableToExcel('table', 'MMS Employee Report')" value="Export XLS" class="btn-success"></td>
                                </tr>
                                <tr>
                                    <td>
                                       <!--table here-->
        ...
        <?php
                                            while($row_emp = mysql_fetch_array($sql_filter)){
                                                ...
                                                echo '<tr class="data2">
                                                        <td>'.$row_emp['emp_num'].'</td>
                                                        <td>'.$fullname.'</td>
                                                        <td>'.ucwords($row_emp['st_brgy'].', '.$row_emp['town_city'].', '.$row_emp['province']).'</td>
                                                        <td>'.date('F d, Y', strtotime($row_emp['birthdate'])).'</td>
                                                        <td>'.ucwords($row_emp['civil_status']).'</td>
                                                        ...
                                                        <td>'.$row_EmpComp['name'].'</td>
                                                        <td>'.$row_EmpBra['branch_name'].'</td>
                                                        <td>'.$row_EmpPos['position'].'</td>
                                                        <td>'.ucwords($row_EmpStat['code']).'</td>
