                                            ...
                                            <?php
                                                while($row_tns = mysql_fetch_array($sql_tns)){
                                                    ...
                                                    echo '<tr class="data2">
                                                        ...
                                                        <td class="data"><input type="image" data-jAlert data-title="Training and Seminar Records" title="View" data-iframe="view_emp_tns.php?tns_id='.$row_tns['tns_id'].'" data-fullscreen="true" src="../../images/button/view_icon.png" width="40" height="40"> | <input type="image" src="../../images/button/edit_icon.png" title="Edit" class="edit" id="'.$row_tns['tns_id'].'" width="40" height="40"></td>
                                                    </tr>';
                                                }
                                            ?>
                                        </table>
