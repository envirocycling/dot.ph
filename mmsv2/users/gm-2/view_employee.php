...
//                                            @$arr_branch[$row_summary['branch_id']]++;
                            ...
                            } else if ($_GET['status'] == 'toadd') {
                                $tbl_active = 'employee_request';
                                $sql_employees = mysql_query("SELECT * from employees_request WHERE type='add' ORDER by request_id Asc") or die(mysql_error());
                            } else if ($_GET['status'] == 'toedit') {
                                $tbl_active = 'employee_request';
                                $sql_employees = mysql_query("SELECT * from employees_request WHERE type='edit' ORDER by request_id Asc") or die(mysql_error());
                                            ...
                                            <table  class="data display datatable">
                                                ...
                                                while ($row_employees = mysql_fetch_array($sql_employees)) {
                                                    ...
                                                    if ($_GET['status'] == 'deactived') {
                                                        ...
                                                        } else if ($row_clearance['hr_status'] == 'cleared' && $row_clearance['accounting_status'] == 'cleared' && $row_clearance['supervisor_status'] == 'cleared' && $row_clearance['it_status'] == 'cleared' && $row_clearance['treasury_status'] == 'cleared') {
                                                    ...
                                                    echo '<td><input type="image" data-jAlert data-title="Employee Information" title="View" data-iframe="view_emp_data.php?emp_num=' . $row_employees['emp_num'] . '" data-fullscreen="true" src="../../images/button/view_icon.png" width="40" height="40"></td>';
                                                    echo '</tr>';
                                                    $num++;
                                                }
                                                ?>
