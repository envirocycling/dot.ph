            ...
            <div id="da-slider" class="da-slider">
                ...
                <div class="container">
                    ...
                    <div class="main" align="center">
                        ...
                        <table width="90%">
                            <tr>
                                <td class="header1" colspan="5"><span id="header1">Manpower Movement</span><br></td>
                            </tr>
                            <tr>
                                <td colspan="4"><hr></td>
                            </tr>
					...
					?>
                            ...
                            <tr>
                                <td></td>
                                <td></td>
                                <td><input type="radio" name="type" value="ressign" id="reassign" required> Reassign to other branch</td>
                                <td>
                                ...
                                <td id="bh_td" hidden>BH: &nbsp;&nbsp;<span id="bh"></span><input type="hidden" id="bh_box" name="bh_box"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="center"><u><font size="2">Approved By: <?php echo $gm_fullname;?></font></u><input type="hidden" value="<?php echo $row_gm['emp_num'];?>" name="approved_id"></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td align="center"><i><?php echo $row_gmposition['position'];?></i></td>
                                <td></td>
                            </tr>
                        </table>
                        <br><br><br>
