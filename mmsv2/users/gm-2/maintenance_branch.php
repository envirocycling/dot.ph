                                        ...
                                        <table  class="data display datatable">
                                            ...
                                            <?php
                                                ...
                                                while($row_branch= mysql_fetch_array($sql_branch)){
                                                    ...
                                                    echo '<tr>
                                                            <td class="data">'.$row_branch['branch_id'].'</td>
                                                            <td class="data">'.ucwords($row_branch['branch_name']).'</td>
                                                            <td class="data">'.ucwords($row_companywhile['description']).'</td>
                                                            <td class="data">';
        ...
        $('button').click(function(){
                ...
                if(action == 'cancel'){
                    ...
                    if(company_name > 0 && branch_name != ''){
                        var dataX = 'company_name=' + company_name + '&branch_name=' + branch_name + '&action=save';
                            $.ajax({
                    ...
                    if(company_name != '' || branch_name != ''){
                        var dataX = 'branch_id=' + branch_id + '&company_name=' + company_name + '&branch_name=' + branch_name + '&action=update';
