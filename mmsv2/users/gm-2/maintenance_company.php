                ...
                <div class="container">
                    ...
                    <div class="main">
                        <br><br><center>
                            <table width='100%'>
                                <tr>
                                    <td class="header1" colspan="4"><center>Comapany<br></center></td>
                                </tr>
                                <tr>
                                    <td colspan="4"><hr></td>
                                </tr>
                                            ...
                                            <?php
                                                ...
                                                while($row_company = mysql_fetch_array($sql_company)){
                                                    ...
                                                    echo '<tr>
                                                            ...
                                                            <td class="data">'.ucwords($row_company['description']).'</td>
	...
	<script type="text/javascript">
        ...
        $('button').click(function(){
                ...
                if(action == 'cancel'){
                    ...
                    var company_name = ($('#company_name').val()).replace("&","ampersand").replace("ñ","**").replace("Ñ","(*)");
                    var description = ($('#description').val()).replace("&","ampersand").replace("ñ","**").replace("Ñ","(*)");
                    var type = $('#type').val();
                    if(company_name != '' && description != '' && (type == '1' || type == '0')){
                        var dataX = 'company_name=' + company_name + '&description=' + description + '&type=' + type + '&action=save';
                            $.ajax({
                    ...
                    if(company_name != '' || description != ''){
                        var dataX = 'company_id=' + company_id + '&company_name=' + company_name + '&description=' + description + '&type=' + type + '&action=update';
                            $.ajax({
                                url: 'process/maintenance_edit.php',
                                type: 'POST',
                                data: dataX,
