                ...
                <div class="container">
                    ...
                    <div class="main">
                        ...
                        if(isset($_POST['update'])){
                            ...
                            $ses_uname = strtolower($_SESSION['username-2']);
                                ...
                                <tr>
                                    <td align="right">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" style="height:35px;" placeholder="Required" value="<?php echo $_SESSION['username-2'];?>" name="username" autocomplete="off"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
