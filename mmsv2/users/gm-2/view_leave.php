                ...
                <div class="container">
                    ...
                    <div class="title">
                        ...
                        if(isset($_POST['filter'])){
                                if(@$_POST['status'] == 'all'){
                                    ...
                                    $status_filter = 'pending to gm';  
                                }else{
                                    $status_filter = @$_POST['status'];
                                }
                                
                                 $sql_leaves = mysql_query("SELECT * from leaves WHERE status LIKE '$status_filter%' and date_submitted >= '".$_POST['from']."' and date_submitted <= '".$_POST['to']."' ORDER by date_submitted Asc") or die(mysql_error());
                                 $from = $_POST['from'];
                                 $to = $_POST['to'];
                            }else{
                                 $sql_leaves = mysql_query("SELECT * from leaves WHERE status = 'pending to gm' and date_submitted LIKE '".date('Y')."%'  ORDER by date_submitted Asc") or die(mysql_error());
                                 $from = date('Y/m');
                                 $from = $from.'/01'; 
                                $to = date('Y/m/t');                                
                            }
                    ...
                    <div class="main">
                        <br><br><center>
                            <table width='100%'>
                                <tr>
                                    <td class="header1" colspan="4"><center>Leaves<br></center></td>
                                </tr>
                                <tr>
                                    <td colspan="4"><hr></td>
                                </tr>
