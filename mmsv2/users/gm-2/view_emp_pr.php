...
date_default_timezone_set("Asia/Singapore");
    ...
    if(isset($_POST['approve'])){
        if(mysql_query("UPDATE personnel_requisition SET gm_status='approved', gm_date='$date' WHERE  pr_id = '".$_GET['pr_id']."'") or die(mysql_error())){
          echo '<script>
        ...
        if(mysql_query("UPDATE personnel_requisition SET status='disapproved', gm_status='disapproved', gm_date='$date', hr_status='' WHERE  pr_id = '".$_GET['pr_id']."'") or die(mysql_error())){
          echo '<script>
                window.top.location.href="view_pr.php?status=active&active=view&http=200";
            </script>';  
        }else{
    ...
    <center>        
        ...
        <br><br>
                            ...
                            <tr>
                                ...
                                <td  colspan="3">
                                    <?php if($row_pr['gm_status'] == 'approved'){?><img src="../../images/signature/<?php echo $row_approvedby['emp_num'].'.png';?>" width="80" height="80"><?php }?>
                                    <?php if($row_pr['gm_status'] == 'pending'){ echo '<form method="post" onsubmit="return confirm(\'Do you want to proceed?\');"><input type="submit" class="btn btn-success" value="Approve" name="approve">  |  <input type="submit" class="btn btn-danger" value="disapprove" name="disapprove"></form>';}?>
                                    <br><span class="view_val"><?php echo $fullname_app;?></span></td>
                            </tr>
                            <tr>
                                <td align="right"><br></td>
                        ...
                        ?><img src="../../images/signature/<?php echo $row_hr['emp_num'].'.png';?>" width="80" height="80"><br><span class="view_val"><?php } echo $fullname_hr;?></span></td>
                            </tr>
                            <tr>
                                <td align="right"></td>
                                <td colspan="3" class="sig_pos"><?php echo $row_position_hr['position'];?></td>
                            </tr>
                            <tr>
                                <td colspan="3"><hr></td>
                            </tr>
