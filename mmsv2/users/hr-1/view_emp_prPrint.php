...
<link rel="stylesheet" type="text/css" href="css/pr_formPrint.css">
<style>
    table{
        font-size: 12px;
    }
...
<table width="95%">
    <tr>
        <td class="header1" colspan="4"><img src="../../images/logo.png" height="55" width="55"><span id="header1">Envirocycling Fiber Incorporated</span><br><span id="header2">Personnel Requisition Form</span></td>
    </tr>
    <tr>
        <td colspan="4"><hr></td>
    </tr>
    <tr>
        <td colspan="2">Date Requested: <span class="view_val"><?php echo date('F d, Y', strtotime($row_pr['date_requested'])); ?><span></td>
                    <td colspan="2" style="width:650px;">Branch: <span class="view_val"><?php echo ucwords($row_branch['branch_name']); ?></span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4"><br><b>II. REASON FOR NEEDED</b></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2"><br><div class="label_info"><input type="checkbox" name="reason" value="r2" disabled <?php echo @$r2; ?>> Replacement of Promoted Employee</div></td>
                        <td colspan="2" class="view_val"><div class="label_info"><?php echo $reason[3]; ?></div></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2"><br><div class="label_info"><input type="checkbox" name="reason" value="r4" disabled <?php echo @$r4; ?>> Requisition for new manpower</div></td>
                    ...
                    <tr>
                        <td colspan="2"><div class="label_info"><br>Salary: <span class="view_val"><?php echo 'Php ' . number_format($row_pr['salary'], 2); ?><span></div></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3"><img src="../../images/signature/<?php echo $row_pr['prepared_id'] . '.png'; ?>" width="45" height="45"><br><span class="view_val"><?php echo $fullname_pre; ?></span></td>
                                        </tr>
                                        <tr>
                                            <td align="right"><br></td>
                                            <td class="sig_pos"><?php echo $row_position_pre['position']; ?></td>
                                        </tr>
                                        <tr>
                                            <td align="right"><div class="label_info">Approved By: </div></td>
                                            <td><?php if ($row_pr['gm_status'] == 'approved') { ?><img src="../../images/signature/<?php echo $row_approvedby['emp_num'] . '.png'; ?>" width="45" height="45"><?php } ?><br><span class="view_val"><?php echo $fullname_app; ?></span></td>
                                            <td align="right"><div class="label_info">Action<br>Performed By: </div></td>
                                            <td>
                                                <?php
                                                if ($row_pr['hr_status'] == 'noted' || $row_pr['hr_status'] == 'served') {
                                                    ?><img src="../../images/signature/<?php echo $row_hr['emp_num'] . '.png'; ?>" width="45" height="45"><br><?php } echo '<span class="view_val">' . $fullname_hr; ?></span></td>
                                        </tr>
                                        <tr>
                                            <td align="right"><br></td>
                                            <td class="sig_pos"><?php echo $row_position_app['position']; ?><br><br><br></td>
                                            <td align="right"><br></td>
                                            <td class="sig_pos"><?php echo $row_position_hr['position'];?><br><br><br></td>
                                        </tr>
                                        </table>
                                        <br>
