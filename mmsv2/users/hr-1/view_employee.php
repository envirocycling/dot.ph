                                    ...
                                    <td>
                                        <table  class="data display datatable">
                                            <thead>
                                                <tr class="data">
                                                    ...
                                                    if ($_GET['status'] == 'deactived') {
                                                        echo '<th class="data">Date Separated</th>';
                                                        echo '<th class="data">Reason</th>';
                                                    }
                                                    ?>
                                            ...
                                            while ($row_employees = mysql_fetch_array($sql_employees)) {
                                                ...
                                                echo '<tr class="data2">';
                                                    if ($_GET['status'] == 'deactived') {
                                                        echo '<td>'.$row_employees['date_separated'].'</td>';
                                                        echo '<td>'.$row_employees['reason'].'</td>';
                                                    }
                                                ...
                                                if ($_GET['status'] == 'deactived') {
                                                    ...
                                                    } else if($row_clearance['hr_status'] != 'cleared'){
