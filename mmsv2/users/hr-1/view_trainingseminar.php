                ...
                <div class="container">
                    ...
                    <div class="title">
                        ...
                        if (isset($_POST['filter'])) {
                            ...
                            $sql_tns = mysql_query("SELECT * from training_seminar WHERE from_date LIKE '" . date('Y') . "%'") or die(mysql_error());
                            $year = date('Y');
                        }
                        ?>
                    </div>
                                        ...
                                        <table  class="data display datatable">
                                            ...
                                            while ($row_tns = mysql_fetch_array($sql_tns)) {
                                                ...
                                                echo '<tr class="data2">
                                                        ...
                                                        <td class="data"><input type="image" data-jAlert data-title="Training and Seminar Records" title="View" data-iframe="view_emp_tns.php?tns_id=' . $row_tns['tns_id'] . '" data-fullscreen="true" src="../../images/button/view_icon.png" width="40" height="40">';
//                                                if ($row_tns['status'] == 'pending to gm') {
                                                    echo ' | <input type="image" src="../../images/button/edit_icon.png" title="Edit" class="edit" id="' . $row_tns['tns_id'] . '" width="40" height="40"></td>';
//                                                }
                                                echo '</tr>';
                                            }
                                            ?>
