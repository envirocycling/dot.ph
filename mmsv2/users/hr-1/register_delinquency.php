                        ...
                        <form action="process/register_del_pro.php" method="post">
                            <table width="85%">
                                ...
                                <tr>
                                    ...
                                    <td width="20%" style="padding-top: 10px;"><br><span id="branch_html"></span><input type="hidden" id="branch" name="branch_id" required></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><br><br>
                                        <input type="checkbox" name="del_type" class="radio" value="incident">Incident &nbsp;&nbsp;<input type="checkbox" class="radio" name="del_type" value="accident">Accident &nbsp;&nbsp;
                                        <span id="report_num">
                                            <select name="report_number"  style="word-wrap:break-word;width:100%;">
                                            </select>
                                        </span>
                                    </td>
                                </tr>
                                   ...
                                   $(document).ready(function () {
                                       $(document).keypress(
                                               function (event) {
                                                   if (event.which == '13') {
                                                       ...
                                                       alert("Please fill-out all fields and click the button to submit.");
                                                   }
                                               });
                                       ...
                                       $('#emp_num').change(function () {
                                           ...
                                           $.ajax({
                                               ...
                                               url: 'process/register_del2.php'
                                           }).done(function (e) {
                                               $('select[name="report_number"]').html(e);
