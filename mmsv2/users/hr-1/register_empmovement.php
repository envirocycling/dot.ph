                ...
                <div class="container">
					...
					?>
                            ...
                            <tr>
                                ...
                                <td align="center" colspan="2"><u><font size="2">Approved By: <?php echo $hr_fullname;?></font></u><input type="hidden" value="<?php echo $row_hr['emp_num'];?>" name="approved_id"></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td></td>
                                <td align="center"><i><?php echo $row_position['position'];?></i></td>
                                <td align="center" colspan="2"><i><?php echo $row_hrposition['position'];?></i></td>
                            </tr>
                        </table>
                        <br><br><br>
