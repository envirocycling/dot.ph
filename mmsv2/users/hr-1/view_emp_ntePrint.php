...
<center>
    <table>
        ...
        <tr>
            <td colspan="2"><?php echo '<img src="../../images/signature/' . $row_nte['supervisor_num'] . '.png" width="50"><br/><span class="txt3">' . $employee_fullname_sub . '</span><br><span class="txt4">' . $row_pos['position'] . '</span><br /><br /><br />'; ?></td>
            <td></td>
        </tr>
        <tr>
