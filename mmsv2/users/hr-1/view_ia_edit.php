                    ...
                    <form action="process/register_ia.php" method="post">
                        ...
                        <table width="70%">
                            ...
                            <tr>
                                <td>Category:</td>
                                <td>
                                    <span name="spnCategory" hidden><?php echo $row_ia['category'];?></span>
                            ...
                            <tr>
                                <td>Cost:</td>
                                <td><input type="number" placeholder="optional" name="cost" value="<?php echo $row_ia['cost'];?>"></td>
                            </tr>
                            <tr>
...
//date picker3 end
                                ...
                                $(document).ready(function () {
                                    ...
                                    $.each($('[name=category] option'),function(){
                                        var _thisVal = this.value;
                                        var spnCategory = $('[name=spnCategory]').text();
                                        if(spnCategory === _thisVal){
