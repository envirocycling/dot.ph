...
//    }
    ...
    <table width="70%">
        ...
        ?>
        <?php
        if ($row_ia['final_category'] == 'for billing' && $row_ia['status'] == 'pending to accounting') {
            echo '<br><span name="spnstatus" hidden>' . $row_ia['status'] . '</span>';
            echo '<tr>
                                <td><br><span class="txt">Status:</span>' . ucwords($row_ia['status']) . ' &nbsp;&nbsp;<button class="btn btn-primary" name="markAsCleared">Mark as Cleared</button></td>
                            </tr>';
        }
        ?>
        <tr>
