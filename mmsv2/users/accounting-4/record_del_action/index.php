...
if (isset($_POST['submit'])) {
    ...
    $sql_emailCC = mysql_query("SELECT * from email WHERE department = 'accounting' and status=''") or die(mysql_error());
