                    ...
                    <div class="title">
                        ...
                        include 'layout/menu.php';
                            if(isset($_POST['filter'])){
                                 $sql_tns = mysql_query("SELECT * from training_seminar WHERE date LIKE '".$_POST['year']."%'") or die(mysql_error());
                                 $year = $_POST['year'];
                            }else{
                                 $sql_tns = mysql_query("SELECT * from training_seminar WHERE date LIKE '".date('Y')."%'") or die(mysql_error());
                                 $year = date('Y');                                
                            }
                        ?>
                    </div>
                                        ...
                                        <table  class="data display datatable">
                                            ...
                                            <?php
                                                while($row_tns = mysql_fetch_array($sql_tns)){
                                                    ...
                                                    echo '<tr class="data">
                                                        <td>'.date('Y/m/d', strtotime($row_tns['date'])).'</td>
                                                        <td>'.$row_tns['title'].'</td>
