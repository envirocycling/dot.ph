                    ...
                    <div class="main">
                        ...
                        <div class="main_wrapper">
                            ...
                            <div id="event_frames">
                                ...
                                $sql_noti_ia = mysql_query("SELECT * from incident_accident WHERE status='pending to accounting'") or die(mysql_error());
                                $row_noti_ia = mysql_num_rows($sql_noti_ia);
                                if ($row_noti_ia > 0) {
                                    echo '<a href="view_ia.php?active=view&page=pending">You have <font color="black">' . $row_noti_ia . ' pending billing request to deduct</font>.</a><hr>';
                                }

                                $sql_noti_del = mysql_query("SELECT * from delinquency WHERE implementation_status='pending to accounting' and cost > 0 ") or die(mysql_error());
                                ...
                                if ($_SESSION['dep_id'] == '2') {
                                    $sql_noti_sepa = mysql_query("SELECT * from form_clearance WHERE accounting_status!='cleared'") or die(mysql_error());
                                } else {
                                    $sql_noti_sepa = mysql_query("SELECT * from form_clearance WHERE treasury_status!='cleared'") or die(mysql_error());
                                }
