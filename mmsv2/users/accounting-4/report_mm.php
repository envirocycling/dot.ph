                                        ...
                                        <table  class="data display datatable"  id="example">
                                            ...
                                            if(@$_POST['sort_by'] != 'Name'){
                                                while($row_mm = mysql_fetch_array($sql_mm)){
                                                    ...
                                                    if((@$_POST['sort_by'] == 'Date') || (!isset($_POST['sort_by']))){
                                                                ...
                                                                if($row_mm['class'] == 'permanent'){
                                                                    $date_effective = date('Y/m/d', strtotime($row_mm['per_date']));
                                                                }else{
                                                                    $date_effective = date('Y/m/d', strtotime($row_mm['temp_date1'])).' - '.date('Y/m/d', strtotime($row_mm['temp_date2']));
                                                                }
                                                        ...
                                                        if (strpos($row_user['branch_id'], '('.$row_mm['branch_id'].')') !== false) {           
                                                            echo '<tr>
                                                                    ...
                                                                    <td class="data">'.$date_effective.'</td>
                                                                    <td class="data">'.$type_val.'</td>
                                                                    <td class="data">'.$entitled.'</td>
                                                            </tr>';
                                                        }
                                                    }
                                                }
                                                ...
                                                while($row_amp_act = mysql_fetch_array($sql_emp_act)){ 
                                                        if (strpos($row_user['branch_id'], '('.$row_amp_act['branch_id'].')') !== false) { 
