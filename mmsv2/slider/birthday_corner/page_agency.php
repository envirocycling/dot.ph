...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:'Open Sans',sans-serif,arial,helvetica,verdana">
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:600px;height:400px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:600px;height:300px;overflow:hidden;">
            ...
            @session_start();
            echo '<br>';
            $sql_bday = mysql_query("SELECT DATE_FORMAT(`birthdate`,'%m-%d') as birthdate, DATE_FORMAT(`birthdate`,'%Y-%m-%d') as birthdate2, lastname, firstname, middlename, emp_num, company_id from employees WHERE company_id = '".$_SESSION['company_id']."' Order By birthdate Asc") or die(mysql_error());
            while ($row_bday = mysql_fetch_array($sql_bday)) {
                ...
                if ($c_month == $row_m && $c_day <= $row_day) {
                    ...
                    $image_path = "../../images/emp-data/".$row_bday['emp_num'].".png";
                    if(file_exists($image_path)){
                        $src =   "../../images/emp-data/".$row_bday['emp_num'].".png";
                    }else{
                        $src =   "../../images/icon.png";
                    }
                    echo '<div>
